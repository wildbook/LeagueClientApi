...
namespace LeagueClientApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LcdsInviteFailed :  IEquatable<LcdsInviteFailed>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LcdsInviteFailed" /> class.
        /// </summary>
        /// <param name="Exception">Exception.</param>
        /// <param name="SummonerId">SummonerId.</param>
        /// <param name="SummonerName">SummonerName.</param>
        public LcdsInviteFailed(LcdsGameInviteBaseRuntimeException Exception = default(LcdsGameInviteBaseRuntimeException), long? SummonerId = default(long?), string SummonerName = default(string))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as LcdsInviteFailed);
        }

        /// <summary>
        /// Returns true if LcdsInviteFailed instances are equal
        /// </summary>
        /// <param name="other">Instance of LcdsInviteFailed to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LcdsInviteFailed other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
