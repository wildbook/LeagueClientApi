...
namespace LeagueClientApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LolLobbyAutoFillQueueDto :  IEquatable<LolLobbyAutoFillQueueDto>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LolLobbyAutoFillQueueDto" /> class.
        /// </summary>
        ...
        public LolLobbyAutoFillQueueDto(bool? AutoFillEligible = default(bool?), bool? AutoFillProtectedForPromos = default(bool?), bool? AutoFillProtectedForStreaking = default(bool?), int? QueueId = default(int?))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as LolLobbyAutoFillQueueDto);
        }

        /// <summary>
        /// Returns true if LolLobbyAutoFillQueueDto instances are equal
        /// </summary>
        /// <param name="other">Instance of LolLobbyAutoFillQueueDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LolLobbyAutoFillQueueDto other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
