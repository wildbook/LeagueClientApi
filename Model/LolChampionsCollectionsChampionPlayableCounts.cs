...
namespace LeagueClientApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LolChampionsCollectionsChampionPlayableCounts :  IEquatable<LolChampionsCollectionsChampionPlayableCounts>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LolChampionsCollectionsChampionPlayableCounts" /> class.
        /// </summary>
        ...
        public LolChampionsCollectionsChampionPlayableCounts(int? ChampionsFreeToPlay = default(int?), int? ChampionsFreeToPlayReward = default(int?), int? ChampionsOwned = default(int?), int? ChampionsRented = default(int?))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as LolChampionsCollectionsChampionPlayableCounts);
        }

        /// <summary>
        /// Returns true if LolChampionsCollectionsChampionPlayableCounts instances are equal
        /// </summary>
        /// <param name="other">Instance of LolChampionsCollectionsChampionPlayableCounts to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LolChampionsCollectionsChampionPlayableCounts other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
