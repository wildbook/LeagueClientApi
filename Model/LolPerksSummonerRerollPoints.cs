...
namespace LeagueClientApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LolPerksSummonerRerollPoints :  IEquatable<LolPerksSummonerRerollPoints>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LolPerksSummonerRerollPoints" /> class.
        /// </summary>
        ...
        public LolPerksSummonerRerollPoints(long? CurrentPoints = default(long?), int? MaxRolls = default(int?), int? NumberOfRolls = default(int?), long? PointsCostToRoll = default(long?), long? PointsToReroll = default(long?))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as LolPerksSummonerRerollPoints);
        }

        /// <summary>
        /// Returns true if LolPerksSummonerRerollPoints instances are equal
        /// </summary>
        /// <param name="other">Instance of LolPerksSummonerRerollPoints to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LolPerksSummonerRerollPoints other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
