...
{
    /// <summary>
    /// LolChatChatLoginSummonerData
    /// </summary>
    [DataContract]
    public partial class LolChatChatLoginSummonerData :  IEquatable<LolChatChatLoginSummonerData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LolChatChatLoginSummonerData" /> class.
        /// </summary>
        /// <param name="SummonerLevelAndPoints">SummonerLevelAndPoints.</param>
        public LolChatChatLoginSummonerData(LolChatChatLoginSummonerLevelAndPoints SummonerLevelAndPoints = default(LolChatChatLoginSummonerLevelAndPoints))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as LolChatChatLoginSummonerData);
        }

        /// <summary>
        /// Returns true if LolChatChatLoginSummonerData instances are equal
        /// </summary>
        /// <param name="other">Instance of LolChatChatLoginSummonerData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LolChatChatLoginSummonerData other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
