...
namespace LeagueClientApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LolLootLootItem :  IEquatable<LolLootLootItem>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LolLootLootItem" /> class.
        /// </summary>
        ...
        public LolLootLootItem(string Asset = default(string), string DisplayCategories = default(string), long? ExpiryTime = default(long?), string LootName = default(string), string Rarity = default(string), int? RentalGames = default(int?), long? RentalSeconds = default(long?), int? StoreItemId = default(int?), string Tags = default(string), string Type = default(string), string UpgradeLootName = default(string), int? Value = default(int?))
        {
            this.Asset = Asset;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LolLootLootItem {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as LolLootLootItem);
        }

        /// <summary>
        /// Returns true if LolLootLootItem instances are equal
        /// </summary>
        /// <param name="other">Instance of LolLootLootItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LolLootLootItem other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
