...
namespace LeagueClientApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LolPftLoginSession :  IEquatable<LolPftLoginSession>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LolPftLoginSession" /> class.
        /// </summary>
        ...
        public LolPftLoginSession(long? AccountId = default(long?), string IdToken = default(string), string Puuid = default(string), LolPftLoginSessionStates State = default(LolPftLoginSessionStates), long? SummonerId = default(long?))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LolPftLoginSession {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as LolPftLoginSession);
        }

        /// <summary>
        /// Returns true if LolPftLoginSession instances are equal
        /// </summary>
        /// <param name="other">Instance of LolPftLoginSession to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LolPftLoginSession other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
