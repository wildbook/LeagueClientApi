...
namespace LeagueClientApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RankedLeagueListDTO :  IEquatable<RankedLeagueListDTO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RankedLeagueListDTO" /> class.
        /// </summary>
        ...
        public RankedLeagueListDTO(List<RankedLeagueItemDTO> Entries = default(List<RankedLeagueItemDTO>), int? MaxLeagueSize = default(int?), string Name = default(string), long? NextApexUpdate = default(long?), string Queue = default(string), string RequestorsName = default(string), string RequestorsRank = default(string), string Tier = default(string))
        {
        ...
        public List<RankedLeagueItemDTO> Entries { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as RankedLeagueListDTO);
        }

        /// <summary>
        /// Returns true if RankedLeagueListDTO instances are equal
        /// </summary>
        /// <param name="other">Instance of RankedLeagueListDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RankedLeagueListDTO other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
