...
namespace LeagueClientApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LolPerksChampSelectAction :  IEquatable<LolPerksChampSelectAction>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LolPerksChampSelectAction" /> class.
        /// </summary>
        ...
        public LolPerksChampSelectAction(long? ActorCellId = default(long?), int? ChampionId = default(int?), bool? Completed = default(bool?), long? Id = default(long?), string Type = default(string))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as LolPerksChampSelectAction);
        }

        /// <summary>
        /// Returns true if LolPerksChampSelectAction instances are equal
        /// </summary>
        /// <param name="other">Instance of LolPerksChampSelectAction to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LolPerksChampSelectAction other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
