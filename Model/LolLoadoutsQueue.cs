...
namespace LeagueClientApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LolLoadoutsQueue :  IEquatable<LolLoadoutsQueue>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LolLoadoutsQueue" /> class.
        /// </summary>
        /// <param name="IsTeamBuilderManaged">IsTeamBuilderManaged.</param>
        public LolLoadoutsQueue(bool? IsTeamBuilderManaged = default(bool?))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as LolLoadoutsQueue);
        }

        /// <summary>
        /// Returns true if LolLoadoutsQueue instances are equal
        /// </summary>
        /// <param name="other">Instance of LolLoadoutsQueue to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LolLoadoutsQueue other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
