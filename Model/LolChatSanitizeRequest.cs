...
namespace LeagueClientApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LolChatSanitizeRequest :  IEquatable<LolChatSanitizeRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LolChatSanitizeRequest" /> class.
        /// </summary>
        /// <param name="AggressiveScan">AggressiveScan.</param>
        /// <param name="Level">Level.</param>
        /// <param name="RemoveDisallowedChars">RemoveDisallowedChars.</param>
        /// <param name="Texts">Texts.</param>
        public LolChatSanitizeRequest(bool? AggressiveScan = default(bool?), int? Level = default(int?), bool? RemoveDisallowedChars = default(bool?), List<string> Texts = default(List<string>))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as LolChatSanitizeRequest);
        }

        /// <summary>
        /// Returns true if LolChatSanitizeRequest instances are equal
        /// </summary>
        /// <param name="other">Instance of LolChatSanitizeRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LolChatSanitizeRequest other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
