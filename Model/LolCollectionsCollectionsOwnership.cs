...
namespace LeagueClientApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LolCollectionsCollectionsOwnership :  IEquatable<LolCollectionsCollectionsOwnership>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LolCollectionsCollectionsOwnership" /> class.
        /// </summary>
        /// <param name="FreeToPlayReward">FreeToPlayReward.</param>
        /// <param name="Owned">Owned.</param>
        /// <param name="Rental">Rental.</param>
        public LolCollectionsCollectionsOwnership(bool? FreeToPlayReward = default(bool?), bool? Owned = default(bool?), LolCollectionsCollectionsRental Rental = default(LolCollectionsCollectionsRental))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as LolCollectionsCollectionsOwnership);
        }

        /// <summary>
        /// Returns true if LolCollectionsCollectionsOwnership instances are equal
        /// </summary>
        /// <param name="other">Instance of LolCollectionsCollectionsOwnership to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LolCollectionsCollectionsOwnership other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
