...
{
    /// <summary>
    /// RankedLeagueMiniSeriesDTO
    /// </summary>
    [DataContract]
    public partial class RankedLeagueMiniSeriesDTO :  IEquatable<RankedLeagueMiniSeriesDTO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RankedLeagueMiniSeriesDTO" /> class.
        /// </summary>
        ...
        public RankedLeagueMiniSeriesDTO(long? Losses = default(long?), string Progress = default(string), long? Target = default(long?), long? TimeLeftToPlayMillis = default(long?), long? Wins = default(long?))
        {
            this.Losses = Losses;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RankedLeagueMiniSeriesDTO {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as RankedLeagueMiniSeriesDTO);
        }

        /// <summary>
        /// Returns true if RankedLeagueMiniSeriesDTO instances are equal
        /// </summary>
        /// <param name="other">Instance of RankedLeagueMiniSeriesDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RankedLeagueMiniSeriesDTO other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
