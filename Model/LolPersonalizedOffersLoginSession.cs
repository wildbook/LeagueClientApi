...
namespace LeagueClientApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LolPersonalizedOffersLoginSession :  IEquatable<LolPersonalizedOffersLoginSession>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LolPersonalizedOffersLoginSession" /> class.
        /// </summary>
        ...
        public LolPersonalizedOffersLoginSession(long? AccountId = default(long?), Object GasToken = default(Object), string IdToken = default(string), LolPersonalizedOffersLoginSessionStates State = default(LolPersonalizedOffersLoginSessionStates), long? SummonerId = default(long?))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LolPersonalizedOffersLoginSession {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as LolPersonalizedOffersLoginSession);
        }

        /// <summary>
        /// Returns true if LolPersonalizedOffersLoginSession instances are equal
        /// </summary>
        /// <param name="other">Instance of LolPersonalizedOffersLoginSession to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LolPersonalizedOffersLoginSession other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
