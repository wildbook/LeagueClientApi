...
namespace LeagueClientApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LolEndOfGameLoginSummonerData :  IEquatable<LolEndOfGameLoginSummonerData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LolEndOfGameLoginSummonerData" /> class.
        /// </summary>
        /// <param name="SummonerLevelAndPoints">SummonerLevelAndPoints.</param>
        public LolEndOfGameLoginSummonerData(LolEndOfGameLoginSummonerLevelAndPoints SummonerLevelAndPoints = default(LolEndOfGameLoginSummonerLevelAndPoints))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as LolEndOfGameLoginSummonerData);
        }

        /// <summary>
        /// Returns true if LolEndOfGameLoginSummonerData instances are equal
        /// </summary>
        /// <param name="other">Instance of LolEndOfGameLoginSummonerData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LolEndOfGameLoginSummonerData other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
