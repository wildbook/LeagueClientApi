...
namespace LeagueClientApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LolSettingsLoginSession :  IEquatable<LolSettingsLoginSession>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LolSettingsLoginSession" /> class.
        /// </summary>
        /// <param name="AccountId">AccountId.</param>
        /// <param name="GasToken">GasToken.</param>
        /// <param name="State">State.</param>
        /// <param name="SummonerId">SummonerId.</param>
        public LolSettingsLoginSession(long? AccountId = default(long?), Object GasToken = default(Object), LolSettingsLoginSessionStates State = default(LolSettingsLoginSessionStates), long? SummonerId = default(long?))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as LolSettingsLoginSession);
        }

        /// <summary>
        /// Returns true if LolSettingsLoginSession instances are equal
        /// </summary>
        /// <param name="other">Instance of LolSettingsLoginSession to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LolSettingsLoginSession other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
