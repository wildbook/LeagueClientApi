...
namespace LeagueClientApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LolChampSelectChampSelectPlayerSelection :  IEquatable<LolChampSelectChampSelectPlayerSelection>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LolChampSelectChampSelectPlayerSelection" /> class.
        /// </summary>
        ...
        public LolChampSelectChampSelectPlayerSelection(string AssignedPosition = default(string), long? CellId = default(long?), int? ChampionId = default(int?), int? ChampionPickIntent = default(int?), string DisplayName = default(string), string PlayerType = default(string), int? SelectedSkinId = default(int?), long? Spell1Id = default(long?), long? Spell2Id = default(long?), long? SummonerId = default(long?), int? Team = default(int?), long? WardSkinId = default(long?))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as LolChampSelectChampSelectPlayerSelection);
        }

        /// <summary>
        /// Returns true if LolChampSelectChampSelectPlayerSelection instances are equal
        /// </summary>
        /// <param name="other">Instance of LolChampSelectChampSelectPlayerSelection to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LolChampSelectChampSelectPlayerSelection other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
