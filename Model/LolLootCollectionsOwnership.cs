...
namespace LeagueClientApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LolLootCollectionsOwnership :  IEquatable<LolLootCollectionsOwnership>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LolLootCollectionsOwnership" /> class.
        /// </summary>
        /// <param name="FreeToPlayReward">FreeToPlayReward.</param>
        /// <param name="Owned">Owned.</param>
        /// <param name="Rental">Rental.</param>
        public LolLootCollectionsOwnership(bool? FreeToPlayReward = default(bool?), bool? Owned = default(bool?), LolLootCollectionsRental Rental = default(LolLootCollectionsRental))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as LolLootCollectionsOwnership);
        }

        /// <summary>
        /// Returns true if LolLootCollectionsOwnership instances are equal
        /// </summary>
        /// <param name="other">Instance of LolLootCollectionsOwnership to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LolLootCollectionsOwnership other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
