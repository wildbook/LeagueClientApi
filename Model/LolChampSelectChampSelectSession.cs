...
namespace LeagueClientApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LolChampSelectChampSelectSession :  IEquatable<LolChampSelectChampSelectSession>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LolChampSelectChampSelectSession" /> class.
        /// </summary>
        ...
        public LolChampSelectChampSelectSession(List<Object> Actions = default(List<Object>), bool? AllowBattleBoost = default(bool?), bool? AllowRerolling = default(bool?), bool? AllowSkinSelection = default(bool?), LolChampSelectChampSelectBannedChampions Bans = default(LolChampSelectChampSelectBannedChampions), LolChampSelectChampSelectChatRoomDetails ChatDetails = default(LolChampSelectChampSelectChatRoomDetails), bool? IsSpectating = default(bool?), long? LocalPlayerCellId = default(long?), List<LolChampSelectChampSelectPlayerSelection> MyTeam = default(List<LolChampSelectChampSelectPlayerSelection>), int? RerollsRemaining = default(int?), List<LolChampSelectChampSelectPlayerSelection> TheirTeam = default(List<LolChampSelectChampSelectPlayerSelection>), LolChampSelectChampSelectTimer Timer = default(LolChampSelectChampSelectTimer), List<LolChampSelectChampSelectTradeContract> Trades = default(List<LolChampSelectChampSelectTradeContract>))
        {
        ...
        public List<LolChampSelectChampSelectPlayerSelection> MyTeam { get; set; }
        ...
        public List<LolChampSelectChampSelectPlayerSelection> TheirTeam { get; set; }
        ...
        public List<LolChampSelectChampSelectTradeContract> Trades { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as LolChampSelectChampSelectSession);
        }

        /// <summary>
        /// Returns true if LolChampSelectChampSelectSession instances are equal
        /// </summary>
        /// <param name="other">Instance of LolChampSelectChampSelectSession to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LolChampSelectChampSelectSession other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
