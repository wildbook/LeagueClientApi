...
namespace LeagueClientApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LolClashGameflowGameDodge :  IEquatable<LolClashGameflowGameDodge>, IValidatableObject
    {
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as LolClashGameflowGameDodge);
        }

        /// <summary>
        /// Returns true if LolClashGameflowGameDodge instances are equal
        /// </summary>
        /// <param name="other">Instance of LolClashGameflowGameDodge to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LolClashGameflowGameDodge other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
