...
namespace LeagueClientApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class EndOfGameStats :  IEquatable<EndOfGameStats>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EndOfGameStats" /> class.
        /// </summary>
        /// <param name="TimeUntilNextFirstWinBonus">TimeUntilNextFirstWinBonus.</param>
        public EndOfGameStats(long? TimeUntilNextFirstWinBonus = default(long?))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as EndOfGameStats);
        }

        /// <summary>
        /// Returns true if EndOfGameStats instances are equal
        /// </summary>
        /// <param name="other">Instance of EndOfGameStats to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EndOfGameStats other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
