...
namespace LeagueClientApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LolChampSelectChampSelectTimer :  IEquatable<LolChampSelectChampSelectTimer>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LolChampSelectChampSelectTimer" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LolChampSelectChampSelectTimer {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as LolChampSelectChampSelectTimer);
        }

        /// <summary>
        /// Returns true if LolChampSelectChampSelectTimer instances are equal
        /// </summary>
        /// <param name="other">Instance of LolChampSelectChampSelectTimer to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LolChampSelectChampSelectTimer other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
