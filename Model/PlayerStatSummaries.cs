...
namespace LeagueClientApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PlayerStatSummaries :  IEquatable<PlayerStatSummaries>, IValidatableObject
    {
        /// <summary>
        ...
        public PlayerStatSummaries(List<PlayerStatSummary> PlayerStatSummarySet = default(List<PlayerStatSummary>))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PlayerStatSummaries);
        }

        /// <summary>
        /// Returns true if PlayerStatSummaries instances are equal
        /// </summary>
        /// <param name="other">Instance of PlayerStatSummaries to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PlayerStatSummaries other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
