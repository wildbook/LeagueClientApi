...
namespace LeagueClientApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LolClubsPublicClubPlayer :  IEquatable<LolClubsPublicClubPlayer>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LolClubsPublicClubPlayer" /> class.
        /// </summary>
        /// <param name="SummonerId">SummonerId.</param>
        /// <param name="SummonerName">SummonerName.</param>
        public LolClubsPublicClubPlayer(long? SummonerId = default(long?), string SummonerName = default(string))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as LolClubsPublicClubPlayer);
        }

        /// <summary>
        /// Returns true if LolClubsPublicClubPlayer instances are equal
        /// </summary>
        /// <param name="other">Instance of LolClubsPublicClubPlayer to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LolClubsPublicClubPlayer other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
