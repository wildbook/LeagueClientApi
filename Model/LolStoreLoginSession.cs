...
namespace LeagueClientApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LolStoreLoginSession :  IEquatable<LolStoreLoginSession>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LolStoreLoginSession" /> class.
        /// </summary>
        ...
        public LolStoreLoginSession(long? AccountId = default(long?), Object GasToken = default(Object), string IdToken = default(string), LolStoreLoginSessionStates State = default(LolStoreLoginSessionStates), long? SummonerId = default(long?))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as LolStoreLoginSession);
        }

        /// <summary>
        /// Returns true if LolStoreLoginSession instances are equal
        /// </summary>
        /// <param name="other">Instance of LolStoreLoginSession to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LolStoreLoginSession other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
