...
namespace LeagueClientApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LolMissionsCollectionsWardSkin :  IEquatable<LolMissionsCollectionsWardSkin>, IValidatableObject
    {
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as LolMissionsCollectionsWardSkin);
        }

        /// <summary>
        /// Returns true if LolMissionsCollectionsWardSkin instances are equal
        /// </summary>
        /// <param name="other">Instance of LolMissionsCollectionsWardSkin to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LolMissionsCollectionsWardSkin other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
