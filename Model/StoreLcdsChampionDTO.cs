...
namespace LeagueClientApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class StoreLcdsChampionDTO :  IEquatable<StoreLcdsChampionDTO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StoreLcdsChampionDTO" /> class.
        /// </summary>
        ...
        public StoreLcdsChampionDTO(bool? Active = default(bool?), bool? BotEnabled = default(bool?), int? ChampionId = default(int?), List<StoreLcdsChampionSkinDTO> ChampionSkins = default(List<StoreLcdsChampionSkinDTO>), long? EndDate = default(long?), bool? FreeToPlay = default(bool?), bool? FreeToPlayReward = default(bool?), bool? Owned = default(bool?), long? PurchaseDate = default(long?), bool? RankedPlayEnabled = default(bool?), List<string> Sources = default(List<string>), int? WinCountRemaining = default(int?))
        {
            this.Active = Active;
        ...
        public List<StoreLcdsChampionSkinDTO> ChampionSkins { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as StoreLcdsChampionDTO);
        }

        /// <summary>
        /// Returns true if StoreLcdsChampionDTO instances are equal
        /// </summary>
        /// <param name="other">Instance of StoreLcdsChampionDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StoreLcdsChampionDTO other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
