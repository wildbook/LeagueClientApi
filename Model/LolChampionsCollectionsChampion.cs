...
namespace LeagueClientApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LolChampionsCollectionsChampion :  IEquatable<LolChampionsCollectionsChampion>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LolChampionsCollectionsChampion" /> class.
        /// </summary>
        ...
        public LolChampionsCollectionsChampion(bool? Active = default(bool?), string Alias = default(string), string BanVoPath = default(string), bool? BotEnabled = default(bool?), string ChooseVoPath = default(string), List<string> DisabledQueues = default(List<string>), bool? FreeToPlay = default(bool?), int? Id = default(int?), string Name = default(string), LolChampionsCollectionsOwnership Ownership = default(LolChampionsCollectionsOwnership), LolChampionsCollectionsChampionSpell Passive = default(LolChampionsCollectionsChampionSpell), long? Purchased = default(long?), bool? RankedPlayEnabled = default(bool?), List<string> Roles = default(List<string>), List<LolChampionsCollectionsChampionSkin> Skins = default(List<LolChampionsCollectionsChampionSkin>), List<LolChampionsCollectionsChampionSpell> Spells = default(List<LolChampionsCollectionsChampionSpell>), string SquarePortraitPath = default(string), string StingerSfxPath = default(string))
        {
            this.Active = Active;
            this.Alias = Alias;
        ...
        public List<LolChampionsCollectionsChampionSkin> Skins { get; set; }

        /// <summary>
        /// Gets or Sets Spells
        /// </summary>
        [DataMember(Name="spells", EmitDefaultValue=false)]
        public List<LolChampionsCollectionsChampionSpell> Spells { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as LolChampionsCollectionsChampion);
        }

        /// <summary>
        /// Returns true if LolChampionsCollectionsChampion instances are equal
        /// </summary>
        /// <param name="other">Instance of LolChampionsCollectionsChampion to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LolChampionsCollectionsChampion other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
