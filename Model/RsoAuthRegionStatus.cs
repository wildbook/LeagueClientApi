...
namespace LeagueClientApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RsoAuthRegionStatus :  IEquatable<RsoAuthRegionStatus>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RsoAuthRegionStatus" /> class.
        /// </summary>
        ...
        public RsoAuthRegionStatus(bool? Enabled = default(bool?), bool? IsLQFallbackAllowed = default(bool?), bool? IsUserInfoEnabled = default(bool?), string PlatformId = default(string))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as RsoAuthRegionStatus);
        }

        /// <summary>
        /// Returns true if RsoAuthRegionStatus instances are equal
        /// </summary>
        /// <param name="other">Instance of RsoAuthRegionStatus to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RsoAuthRegionStatus other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
