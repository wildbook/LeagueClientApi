...
namespace LeagueClientApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LolQueueEligibilityEligibilityQueryParams :  IEquatable<LolQueueEligibilityEligibilityQueryParams>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LolQueueEligibilityEligibilityQueryParams" /> class.
        /// </summary>
        /// <param name="QueueIds">QueueIds.</param>
        /// <param name="SummonerIds">SummonerIds.</param>
        public LolQueueEligibilityEligibilityQueryParams(List<int?> QueueIds = default(List<int?>), List<long?> SummonerIds = default(List<long?>))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as LolQueueEligibilityEligibilityQueryParams);
        }

        /// <summary>
        /// Returns true if LolQueueEligibilityEligibilityQueryParams instances are equal
        /// </summary>
        /// <param name="other">Instance of LolQueueEligibilityEligibilityQueryParams to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LolQueueEligibilityEligibilityQueryParams other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
