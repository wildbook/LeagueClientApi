...
namespace LeagueClientApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LolChampSelectChampSelectBannedChampions :  IEquatable<LolChampSelectChampSelectBannedChampions>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LolChampSelectChampSelectBannedChampions" /> class.
        /// </summary>
        /// <param name="MyTeamBans">MyTeamBans.</param>
        /// <param name="NumBans">NumBans.</param>
        /// <param name="TheirTeamBans">TheirTeamBans.</param>
        public LolChampSelectChampSelectBannedChampions(List<int?> MyTeamBans = default(List<int?>), int? NumBans = default(int?), List<int?> TheirTeamBans = default(List<int?>))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as LolChampSelectChampSelectBannedChampions);
        }

        /// <summary>
        /// Returns true if LolChampSelectChampSelectBannedChampions instances are equal
        /// </summary>
        /// <param name="other">Instance of LolChampSelectChampSelectBannedChampions to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LolChampSelectChampSelectBannedChampions other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
