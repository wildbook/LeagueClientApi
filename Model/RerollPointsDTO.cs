...
namespace LeagueClientApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RerollPointsDTO :  IEquatable<RerollPointsDTO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RerollPointsDTO" /> class.
        /// </summary>
        ...
        public RerollPointsDTO(long? CurrentPoints = default(long?), int? MaxRolls = default(int?), int? NumberOfRolls = default(int?), long? PointsCostToRoll = default(long?), long? PointsToReroll = default(long?))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as RerollPointsDTO);
        }

        /// <summary>
        /// Returns true if RerollPointsDTO instances are equal
        /// </summary>
        /// <param name="other">Instance of RerollPointsDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RerollPointsDTO other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
