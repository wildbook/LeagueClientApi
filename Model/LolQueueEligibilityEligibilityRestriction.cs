...
namespace LeagueClientApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LolQueueEligibilityEligibilityRestriction :  IEquatable<LolQueueEligibilityEligibilityRestriction>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LolQueueEligibilityEligibilityRestriction" /> class.
        /// </summary>
        ...
        public LolQueueEligibilityEligibilityRestriction(long? ExpiredTimestamp = default(long?), Dictionary<string, string> RestrictionArgs = default(Dictionary<string, string>), LolQueueEligibilityEligibilityRestrictionCode RestrictionCode = default(LolQueueEligibilityEligibilityRestrictionCode), List<long?> SummonerIds = default(List<long?>))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as LolQueueEligibilityEligibilityRestriction);
        }

        /// <summary>
        /// Returns true if LolQueueEligibilityEligibilityRestriction instances are equal
        /// </summary>
        /// <param name="other">Instance of LolQueueEligibilityEligibilityRestriction to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LolQueueEligibilityEligibilityRestriction other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
