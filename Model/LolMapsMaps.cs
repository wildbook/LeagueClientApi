...
namespace LeagueClientApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LolMapsMaps :  IEquatable<LolMapsMaps>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LolMapsMaps" /> class.
        /// </summary>
        /// <param name="Assets">Assets.</param>
        /// <param name="Description">Description.</param>
        /// <param name="GameMode">GameMode.</param>
        /// <param name="GameModeDescription">GameModeDescription.</param>
        ...
        public LolMapsMaps(Dictionary<string, string> Assets = default(Dictionary<string, string>), string Description = default(string), string GameMode = default(string), string GameModeDescription = default(string), string GameModeName = default(string), string GameModeShortName = default(string), string GameMutator = default(string), long? Id = default(long?), bool? IsDefault = default(bool?), bool? IsRGM = default(bool?), string Name = default(string), string PlatformId = default(string), string PlatformName = default(string), Object Properties = default(Object))
        {
            this.Assets = Assets;
        ...
        /// <summary>
        /// Gets or Sets GameModeDescription
        /// </summary>
        [DataMember(Name="gameModeDescription", EmitDefaultValue=false)]
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as LolMapsMaps);
        }

        /// <summary>
        /// Returns true if LolMapsMaps instances are equal
        /// </summary>
        /// <param name="other">Instance of LolMapsMaps to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LolMapsMaps other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                ...
                (
                    this.GameModeDescription == other.GameModeDescription ||
                    this.GameModeDescription != null &&
                    this.GameModeDescription.Equals(other.GameModeDescription)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.GameModeDescription != null)
                    hash = hash * 59 + this.GameModeDescription.GetHashCode();
