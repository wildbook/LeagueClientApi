...
namespace LeagueClientApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LolChatTeamPlayerEntry :  IEquatable<LolChatTeamPlayerEntry>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LolChatTeamPlayerEntry" /> class.
        /// </summary>
        ...
        public LolChatTeamPlayerEntry(long? SummonerId = default(long?), string SummonerInternalName = default(string), string SummonerName = default(string))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as LolChatTeamPlayerEntry);
        }

        /// <summary>
        /// Returns true if LolChatTeamPlayerEntry instances are equal
        /// </summary>
        /// <param name="other">Instance of LolChatTeamPlayerEntry to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LolChatTeamPlayerEntry other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
