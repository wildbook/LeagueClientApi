...
namespace LeagueClientApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LolMatchHistoryMatchHistoryTeamBan :  IEquatable<LolMatchHistoryMatchHistoryTeamBan>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LolMatchHistoryMatchHistoryTeamBan" /> class.
        /// </summary>
        /// <param name="ChampionId">ChampionId.</param>
        /// <param name="PickTurn">PickTurn.</param>
        public LolMatchHistoryMatchHistoryTeamBan(int? ChampionId = default(int?), int? PickTurn = default(int?))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as LolMatchHistoryMatchHistoryTeamBan);
        }

        /// <summary>
        /// Returns true if LolMatchHistoryMatchHistoryTeamBan instances are equal
        /// </summary>
        /// <param name="other">Instance of LolMatchHistoryMatchHistoryTeamBan to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LolMatchHistoryMatchHistoryTeamBan other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
