...
namespace LeagueClientApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LolLobbyTeamBuilderLobbyInvitation :  IEquatable<LolLobbyTeamBuilderLobbyInvitation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LolLobbyTeamBuilderLobbyInvitation" /> class.
        /// </summary>
        /// <param name="InvitationMetaData">InvitationMetaData.</param>
        public LolLobbyTeamBuilderLobbyInvitation(Object InvitationMetaData = default(Object))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as LolLobbyTeamBuilderLobbyInvitation);
        }

        /// <summary>
        /// Returns true if LolLobbyTeamBuilderLobbyInvitation instances are equal
        /// </summary>
        /// <param name="other">Instance of LolLobbyTeamBuilderLobbyInvitation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LolLobbyTeamBuilderLobbyInvitation other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
