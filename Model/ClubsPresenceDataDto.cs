...
{
    /// <summary>
    /// ClubsPresenceDataDto
    /// </summary>
    [DataContract]
    public partial class ClubsPresenceDataDto :  IEquatable<ClubsPresenceDataDto>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ClubsPresenceDataDto" /> class.
        /// </summary>
        ...
        public ClubsPresenceDataDto(string ClubName = default(string), string ClubTag = default(string), long? SummonerId = default(long?), string SummonerName = default(string))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ClubsPresenceDataDto);
        }

        /// <summary>
        /// Returns true if ClubsPresenceDataDto instances are equal
        /// </summary>
        /// <param name="other">Instance of ClubsPresenceDataDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ClubsPresenceDataDto other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
