...
namespace LeagueClientApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LoginSession :  IEquatable<LoginSession>, IValidatableObject
    {
        /// <summary>
        ...
        public LoginSession(long? AccountId = default(long?), string IdToken = default(string), LoginSessionStates State = default(LoginSessionStates), long? SummonerId = default(long?))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as LoginSession);
        }

        /// <summary>
        /// Returns true if LoginSession instances are equal
        /// </summary>
        /// <param name="other">Instance of LoginSession to be compared</param>
        /// <returns>Boolean</returns>
