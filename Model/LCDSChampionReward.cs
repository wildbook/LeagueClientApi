...
namespace LeagueClientApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LCDSChampionReward :  IEquatable<LCDSChampionReward>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LCDSChampionReward" /> class.
        /// </summary>
        /// <param name="ChampionId">ChampionId.</param>
        /// <param name="Skins">Skins.</param>
        public LCDSChampionReward(int? ChampionId = default(int?), List<int?> Skins = default(List<int?>))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as LCDSChampionReward);
        }

        /// <summary>
        /// Returns true if LCDSChampionReward instances are equal
        /// </summary>
        /// <param name="other">Instance of LCDSChampionReward to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LCDSChampionReward other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
