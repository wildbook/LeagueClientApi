...
namespace LeagueClientApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PatcherNotification :  IEquatable<PatcherNotification>, IValidatableObject
    {
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PatcherNotification);
        }

        /// <summary>
        /// Returns true if PatcherNotification instances are equal
        /// </summary>
        /// <param name="other">Instance of PatcherNotification to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PatcherNotification other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
