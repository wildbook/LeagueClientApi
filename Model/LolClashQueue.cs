...
namespace LeagueClientApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LolClashQueue :  IEquatable<LolClashQueue>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LolClashQueue" /> class.
        /// </summary>
        ...
        public LolClashQueue(bool? AreFreeChampionsAllowed = default(bool?), LolClashQueueGameCategory Category = default(LolClashQueueGameCategory), string Description = default(string), string DetailedDescription = default(string), string GameMode = default(string), string GameMutator = default(string), LolClashQueueGameTypeConfig GameTypeConfig = default(LolClashQueueGameTypeConfig), int? Id = default(int?), bool? IsRanked = default(bool?), bool? IsTeamBuilderManaged = default(bool?), bool? IsTeamOnly = default(bool?), int? MapId = default(int?), int? MaxLevel = default(int?), int? MaxSummonerLevelForFirstWinOfTheDay = default(int?), int? MaximumParticipantListSize = default(int?), int? MinLevel = default(int?), int? MinimumParticipantListSize = default(int?), string Name = default(string), int? NumPlayersPerTeam = default(int?), LolClashQueueAvailability QueueAvailability = default(LolClashQueueAvailability), LolClashQueueReward QueueRewards = default(LolClashQueueReward), string ShortName = default(string), bool? SpectatorEnabled = default(bool?), string Type = default(string))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as LolClashQueue);
        }

        /// <summary>
        /// Returns true if LolClashQueue instances are equal
        /// </summary>
        /// <param name="other">Instance of LolClashQueue to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LolClashQueue other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
