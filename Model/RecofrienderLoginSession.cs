...
{
    /// <summary>
    /// RecofrienderLoginSession
    /// </summary>
    [DataContract]
    public partial class RecofrienderLoginSession :  IEquatable<RecofrienderLoginSession>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RecofrienderLoginSession" /> class.
        /// </summary>
        ...
        public RecofrienderLoginSession(long? AccountId = default(long?), Object GasToken = default(Object), string IdToken = default(string), RecofrienderLoginSessionStates State = default(RecofrienderLoginSessionStates), long? SummonerId = default(long?))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RecofrienderLoginSession {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as RecofrienderLoginSession);
        }

        /// <summary>
        /// Returns true if RecofrienderLoginSession instances are equal
        /// </summary>
        /// <param name="other">Instance of RecofrienderLoginSession to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RecofrienderLoginSession other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
