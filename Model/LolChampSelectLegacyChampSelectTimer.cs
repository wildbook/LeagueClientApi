...
namespace LeagueClientApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LolChampSelectLegacyChampSelectTimer :  IEquatable<LolChampSelectLegacyChampSelectTimer>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LolChampSelectLegacyChampSelectTimer" /> class.
        /// </summary>
        ...
        public LolChampSelectLegacyChampSelectTimer(long? AdjustedTimeLeftInPhase = default(long?), int? AdjustedTimeLeftInPhaseInSec = default(int?), long? InternalNowInEpochMs = default(long?), bool? IsInfinite = default(bool?), string Phase = default(string), long? TimeLeftInPhase = default(long?), int? TimeLeftInPhaseInSec = default(int?), long? TotalTimeInPhase = default(long?))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as LolChampSelectLegacyChampSelectTimer);
        }

        /// <summary>
        /// Returns true if LolChampSelectLegacyChampSelectTimer instances are equal
        /// </summary>
        /// <param name="other">Instance of LolChampSelectLegacyChampSelectTimer to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LolChampSelectLegacyChampSelectTimer other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
