...
namespace LeagueClientApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LolChatChatSummoner :  IEquatable<LolChatChatSummoner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LolChatChatSummoner" /> class.
        /// </summary>
        ...
        public LolChatChatSummoner(string DisplayName = default(string), int? ProfileIconId = default(int?), long? SummonerId = default(long?), int? SummonerLevel = default(int?))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as LolChatChatSummoner);
        }

        /// <summary>
        /// Returns true if LolChatChatSummoner instances are equal
        /// </summary>
        /// <param name="other">Instance of LolChatChatSummoner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LolChatChatSummoner other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
