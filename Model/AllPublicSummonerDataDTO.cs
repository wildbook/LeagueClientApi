...
namespace LeagueClientApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AllPublicSummonerDataDTO :  IEquatable<AllPublicSummonerDataDTO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AllPublicSummonerDataDTO" /> class.
        /// </summary>
        ...
        public AllPublicSummonerDataDTO(BasePublicSummonerDTO Summoner = default(BasePublicSummonerDTO), SummonerLevel SummonerLevel = default(SummonerLevel), SummonerLevelAndPoints SummonerLevelAndPoints = default(SummonerLevelAndPoints))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as AllPublicSummonerDataDTO);
        }

        /// <summary>
        /// Returns true if AllPublicSummonerDataDTO instances are equal
        /// </summary>
        /// <param name="other">Instance of AllPublicSummonerDataDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AllPublicSummonerDataDTO other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
