...
namespace LeagueClientApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LolChampionsGameDataChampionSkin :  IEquatable<LolChampionsGameDataChampionSkin>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LolChampionsGameDataChampionSkin" /> class.
        /// </summary>
        ...
        public LolChampionsGameDataChampionSkin(string CardPath = default(string), string ChromaPath = default(string), List<LolChampionsGameDataChampionChroma> Chromas = default(List<LolChampionsGameDataChampionChroma>), List<LolChampionsCollectionsChampionSkinEmblem> Emblems = default(List<LolChampionsCollectionsChampionSkinEmblem>), string FeaturesText = default(string), int? Id = default(int?), string Name = default(string), string RarityGemPath = default(string), string SkinType = default(string), string SplashPath = default(string), string SplashVideoPath = default(string), string TilePath = default(string), string UncenteredSplashPath = default(string))
        {
        ...
        public List<LolChampionsGameDataChampionChroma> Chromas { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as LolChampionsGameDataChampionSkin);
        }

        /// <summary>
        /// Returns true if LolChampionsGameDataChampionSkin instances are equal
        /// </summary>
        /// <param name="other">Instance of LolChampionsGameDataChampionSkin to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LolChampionsGameDataChampionSkin other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
