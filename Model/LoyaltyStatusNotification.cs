...
namespace LeagueClientApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LoyaltyStatusNotification :  IEquatable<LoyaltyStatusNotification>, IValidatableObject
    {
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as LoyaltyStatusNotification);
        }

        /// <summary>
        /// Returns true if LoyaltyStatusNotification instances are equal
        /// </summary>
        /// <param name="other">Instance of LoyaltyStatusNotification to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LoyaltyStatusNotification other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
