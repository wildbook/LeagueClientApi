...
namespace LeagueClientApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AllSummonerData :  IEquatable<AllSummonerData>, IValidatableObject
    {
        /// <summary>
        ...
        public AllSummonerData(PrivateSummonerDTO Summoner = default(PrivateSummonerDTO), SummonerLevel SummonerLevel = default(SummonerLevel), SummonerLevelAndPoints SummonerLevelAndPoints = default(SummonerLevelAndPoints))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as AllSummonerData);
        }

        /// <summary>
        /// Returns true if AllSummonerData instances are equal
        /// </summary>
        /// <param name="other">Instance of AllSummonerData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AllSummonerData other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
