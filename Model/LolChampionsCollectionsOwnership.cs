...
namespace LeagueClientApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LolChampionsCollectionsOwnership :  IEquatable<LolChampionsCollectionsOwnership>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LolChampionsCollectionsOwnership" /> class.
        /// </summary>
        /// <param name="FreeToPlayReward">FreeToPlayReward.</param>
        /// <param name="Owned">Owned.</param>
        /// <param name="Rental">Rental.</param>
        public LolChampionsCollectionsOwnership(bool? FreeToPlayReward = default(bool?), bool? Owned = default(bool?), LolChampionsCollectionsRental Rental = default(LolChampionsCollectionsRental))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as LolChampionsCollectionsOwnership);
        }

        /// <summary>
        /// Returns true if LolChampionsCollectionsOwnership instances are equal
        /// </summary>
        /// <param name="other">Instance of LolChampionsCollectionsOwnership to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LolChampionsCollectionsOwnership other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
