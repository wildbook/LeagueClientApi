...
namespace LeagueClientApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LolSummonerSummonerIdAndIcon :  IEquatable<LolSummonerSummonerIdAndIcon>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LolSummonerSummonerIdAndIcon" /> class.
        /// </summary>
        /// <param name="ProfileIconId">ProfileIconId.</param>
        /// <param name="SummonerId">SummonerId.</param>
        public LolSummonerSummonerIdAndIcon(int? ProfileIconId = default(int?), long? SummonerId = default(long?))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as LolSummonerSummonerIdAndIcon);
        }

        /// <summary>
        /// Returns true if LolSummonerSummonerIdAndIcon instances are equal
        /// </summary>
        /// <param name="other">Instance of LolSummonerSummonerIdAndIcon to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LolSummonerSummonerIdAndIcon other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
