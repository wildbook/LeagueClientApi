...
namespace LeagueClientApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LolGameQueuesQueueGameTypeConfig :  IEquatable<LolGameQueuesQueueGameTypeConfig>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LolGameQueuesQueueGameTypeConfig" /> class.
        /// </summary>
        ...
        public LolGameQueuesQueueGameTypeConfig(bool? AdvancedLearningQuests = default(bool?), bool? AllowTrades = default(bool?), string BanMode = default(string), int? BanTimerDuration = default(int?), bool? BattleBoost = default(bool?), bool? CrossTeamChampionPool = default(bool?), bool? DeathMatch = default(bool?), bool? DoNotRemove = default(bool?), bool? DuplicatePick = default(bool?), bool? ExclusivePick = default(bool?), string GameModeOverride = default(string), long? Id = default(long?), bool? LearningQuests = default(bool?), int? MainPickTimerDuration = default(int?), int? MaxAllowableBans = default(int?), string Name = default(string), int? NumPlayersPerTeamOverride = default(int?), bool? OnboardCoopBeginner = default(bool?), string PickMode = default(string), int? PostPickTimerDuration = default(int?), bool? Reroll = default(bool?), bool? TeamChampionPool = default(bool?))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as LolGameQueuesQueueGameTypeConfig);
        }

        /// <summary>
        /// Returns true if LolGameQueuesQueueGameTypeConfig instances are equal
        /// </summary>
        /// <param name="other">Instance of LolGameQueuesQueueGameTypeConfig to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LolGameQueuesQueueGameTypeConfig other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
