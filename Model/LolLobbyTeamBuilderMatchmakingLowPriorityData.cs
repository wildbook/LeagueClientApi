...
namespace LeagueClientApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LolLobbyTeamBuilderMatchmakingLowPriorityData :  IEquatable<LolLobbyTeamBuilderMatchmakingLowPriorityData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LolLobbyTeamBuilderMatchmakingLowPriorityData" /> class.
        /// </summary>
        ...
        public LolLobbyTeamBuilderMatchmakingLowPriorityData(string BustedLeaverAccessToken = default(string), List<long?> PenalizedSummonerIds = default(List<long?>), double? PenaltyTime = default(double?), double? PenaltyTimeRemaining = default(double?))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LolLobbyTeamBuilderMatchmakingLowPriorityData {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as LolLobbyTeamBuilderMatchmakingLowPriorityData);
        }

        /// <summary>
        /// Returns true if LolLobbyTeamBuilderMatchmakingLowPriorityData instances are equal
        /// </summary>
        /// <param name="other">Instance of LolLobbyTeamBuilderMatchmakingLowPriorityData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LolLobbyTeamBuilderMatchmakingLowPriorityData other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
