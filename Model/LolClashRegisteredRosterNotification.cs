...
namespace LeagueClientApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LolClashRegisteredRosterNotification :  IEquatable<LolClashRegisteredRosterNotification>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LolClashRegisteredRosterNotification" /> class.
        /// </summary>
        /// <param name="NotifyReason">NotifyReason.</param>
        /// <param name="Roster">Roster.</param>
        public LolClashRegisteredRosterNotification(LolClashRosterNotifyReason NotifyReason = default(LolClashRosterNotifyReason), RosterDTO Roster = default(RosterDTO))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as LolClashRegisteredRosterNotification);
        }

        /// <summary>
        /// Returns true if LolClashRegisteredRosterNotification instances are equal
        /// </summary>
        /// <param name="other">Instance of LolClashRegisteredRosterNotification to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LolClashRegisteredRosterNotification other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
