...
namespace LeagueClientApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ActiveBoostsLcdsSummonerActiveBoostsDTO :  IEquatable<ActiveBoostsLcdsSummonerActiveBoostsDTO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ActiveBoostsLcdsSummonerActiveBoostsDTO" /> class.
        /// </summary>
        ...
        public ActiveBoostsLcdsSummonerActiveBoostsDTO(long? IpBoostEndDate = default(long?), int? IpBoostPerWinCount = default(int?), int? IpLoyaltyBoost = default(int?), long? SummonerId = default(long?), long? XpBoostEndDate = default(long?), int? XpBoostPerWinCount = default(int?), int? XpLoyaltyBoost = default(int?))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ActiveBoostsLcdsSummonerActiveBoostsDTO);
        }

        /// <summary>
        /// Returns true if ActiveBoostsLcdsSummonerActiveBoostsDTO instances are equal
        /// </summary>
        /// <param name="other">Instance of ActiveBoostsLcdsSummonerActiveBoostsDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ActiveBoostsLcdsSummonerActiveBoostsDTO other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
