...
namespace LeagueClientApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class FellowPlayerInfo :  IEquatable<FellowPlayerInfo>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FellowPlayerInfo" /> class.
        /// </summary>
        /// <param name="ChampionId">ChampionId.</param>
        /// <param name="SummonerId">SummonerId.</param>
        /// <param name="TeamId">TeamId.</param>
        public FellowPlayerInfo(long? ChampionId = default(long?), long? SummonerId = default(long?), long? TeamId = default(long?))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as FellowPlayerInfo);
        }

        /// <summary>
        /// Returns true if FellowPlayerInfo instances are equal
        /// </summary>
        /// <param name="other">Instance of FellowPlayerInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FellowPlayerInfo other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
