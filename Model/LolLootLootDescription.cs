...
namespace LeagueClientApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LolLootLootDescription :  IEquatable<LolLootLootDescription>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LolLootLootDescription" /> class.
        /// </summary>
        ...
        public LolLootLootDescription(List<string> ChildLootTableNames = default(List<string>), Dictionary<string, string> LocalizationLongDescriptionMap = default(Dictionary<string, string>), Dictionary<string, string> LocalizationMap = default(Dictionary<string, string>), string LootName = default(string))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as LolLootLootDescription);
        }

        /// <summary>
        /// Returns true if LolLootLootDescription instances are equal
        /// </summary>
        /// <param name="other">Instance of LolLootLootDescription to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LolLootLootDescription other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
