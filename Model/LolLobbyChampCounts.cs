...
namespace LeagueClientApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LolLobbyChampCounts :  IEquatable<LolLobbyChampCounts>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LolLobbyChampCounts" /> class.
        /// </summary>
        ...
        public LolLobbyChampCounts(int? ChampionsFreeToPlay = default(int?), int? ChampionsFreeToPlayReward = default(int?), int? ChampionsOwned = default(int?), int? ChampionsRented = default(int?))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LolLobbyChampCounts {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as LolLobbyChampCounts);
        }

        /// <summary>
        /// Returns true if LolLobbyChampCounts instances are equal
        /// </summary>
        /// <param name="other">Instance of LolLobbyChampCounts to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LolLobbyChampCounts other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
