...
namespace LeagueClientApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LolLoadoutsLoginSession :  IEquatable<LolLoadoutsLoginSession>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LolLoadoutsLoginSession" /> class.
        /// </summary>
        ...
        public LolLoadoutsLoginSession(long? AccountId = default(long?), Object GasToken = default(Object), string IdToken = default(string), string Puuid = default(string), LolLoadoutsLoginSessionStates State = default(LolLoadoutsLoginSessionStates), long? SummonerId = default(long?))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as LolLoadoutsLoginSession);
        }

        /// <summary>
        /// Returns true if LolLoadoutsLoginSession instances are equal
        /// </summary>
        /// <param name="other">Instance of LolLoadoutsLoginSession to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LolLoadoutsLoginSession other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
