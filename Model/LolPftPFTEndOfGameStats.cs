...
namespace LeagueClientApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LolPftPFTEndOfGameStats :  IEquatable<LolPftPFTEndOfGameStats>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LolPftPFTEndOfGameStats" /> class.
        /// </summary>
        ...
        /// <param name="IsAramGame">IsAramGame.</param>
        ...
        public LolPftPFTEndOfGameStats(long? AccountId = default(long?), int? BasePoints = default(int?), int? BattleBoostIpEarned = default(int?), int? BoostIpEarned = default(int?), int? BoostXpEarned = default(int?), bool? CausedEarlySurrender = default(bool?), int? ChampionId = default(int?), int? CoOpVsAiMinutesLeftToday = default(int?), int? CoOpVsAiMsecsUntilReset = default(int?), int? CompletionBonusPoints = default(int?), int? CustomMinutesLeftToday = default(int?), int? CustomMsecsUntilReset = default(int?), string Difficulty = default(string), bool? EarlySurrenderAccomplice = default(bool?), int? Elo = default(int?), int? EloChange = default(int?), int? ExperienceEarned = default(int?), int? ExperienceTotal = default(int?), int? FirstWinBonus = default(int?), bool? GameEndedInEarlySurrender = default(bool?), long? GameId = default(long?), int? GameLength = default(int?), string GameMode = default(string), List<string> GameMutators = default(List<string>), string GameType = default(string), bool? ImbalancedTeamsNoPoints = default(bool?), bool? Invalid = default(bool?), int? IpEarned = default(int?), int? IpTotal = default(int?), bool? IsAramGame = default(bool?), bool? LeveledUp = default(bool?), int? LoyaltyBoostIpEarned = default(int?), int? LoyaltyBoostXpEarned = default(int?), string MyTeamStatus = default(string), List<int?> NewSpells = default(List<int?>), int? OdinBonusIp = default(int?), int? PartyRewardsBonusIpEarned = default(int?), Object PointsPenalties = default(Object), long? PreviousLevel = default(long?), long? PreviousXpTotal = default(long?), int? QueueBonusEarned = default(int?), string QueueType = default(string), bool? Ranked = default(bool?), long? ReportGameId = default(long?), LolPftPFTEndOfGamePoints RerollData = default(LolPftPFTEndOfGamePoints), string RoomName = default(string), string RoomPassword = default(string), int? RpEarned = default(int?), bool? SendStatsToTournamentProvider = default(bool?), int? SkinId = default(int?), int? SkinIndex = default(int?), long? SummonerId = default(long?), string SummonerName = default(string), int? TalentPointsGained = default(int?), bool? TeamEarlySurrendered = default(bool?), List<LolPftPFTEndOfGameTeam> Teams = default(List<LolPftPFTEndOfGameTeam>), int? TimeUntilNextFirstWinBonus = default(int?), long? UserId = default(long?))
        {
        ...
        /// <summary>
        /// Gets or Sets IsAramGame
        /// </summary>
        [DataMember(Name="isAramGame", EmitDefaultValue=false)]
        ...
        public List<LolPftPFTEndOfGameTeam> Teams { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as LolPftPFTEndOfGameStats);
        }

        /// <summary>
        /// Returns true if LolPftPFTEndOfGameStats instances are equal
        /// </summary>
        /// <param name="other">Instance of LolPftPFTEndOfGameStats to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LolPftPFTEndOfGameStats other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                ...
                (
                    this.IsAramGame == other.IsAramGame ||
                    this.IsAramGame != null &&
                    this.IsAramGame.Equals(other.IsAramGame)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.IsAramGame != null)
                    hash = hash * 59 + this.IsAramGame.GetHashCode();
