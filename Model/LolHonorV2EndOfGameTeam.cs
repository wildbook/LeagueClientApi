...
namespace LeagueClientApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LolHonorV2EndOfGameTeam :  IEquatable<LolHonorV2EndOfGameTeam>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LolHonorV2EndOfGameTeam" /> class.
        /// </summary>
        ...
        public LolHonorV2EndOfGameTeam(List<int?> ChampionBans = default(List<int?>), string FullId = default(string), bool? IsBottomTeam = default(bool?), bool? IsPlayerTeam = default(bool?), bool? IsWinningTeam = default(bool?), string MemberStatusString = default(string), string Name = default(string), List<LolHonorV2EndOfGamePlayer> Players = default(List<LolHonorV2EndOfGamePlayer>), Object Stats = default(Object), string Tag = default(string), int? TeamId = default(int?))
        {
        ...
        public List<LolHonorV2EndOfGamePlayer> Players { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as LolHonorV2EndOfGameTeam);
        }

        /// <summary>
        /// Returns true if LolHonorV2EndOfGameTeam instances are equal
        /// </summary>
        /// <param name="other">Instance of LolHonorV2EndOfGameTeam to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LolHonorV2EndOfGameTeam other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
