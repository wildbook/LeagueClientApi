...
namespace LeagueClientApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LolChatSpectateGameInfoResource :  IEquatable<LolChatSpectateGameInfoResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LolChatSpectateGameInfoResource" /> class.
        /// </summary>
        ...
        public LolChatSpectateGameInfoResource(string AllowObserveMode = default(string), string DropInSpectateGameId = default(string), string GameQueueType = default(string))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as LolChatSpectateGameInfoResource);
        }

        /// <summary>
        /// Returns true if LolChatSpectateGameInfoResource instances are equal
        /// </summary>
        /// <param name="other">Instance of LolChatSpectateGameInfoResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LolChatSpectateGameInfoResource other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
