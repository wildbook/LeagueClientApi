...
namespace LeagueClientApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PersonalizedOffersLcdsChampionSkinDTO :  IEquatable<PersonalizedOffersLcdsChampionSkinDTO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PersonalizedOffersLcdsChampionSkinDTO" /> class.
        /// </summary>
        /// <param name="ChampionId">ChampionId.</param>
        /// <param name="Owned">Owned.</param>
        /// <param name="SkinId">SkinId.</param>
        public PersonalizedOffersLcdsChampionSkinDTO(int? ChampionId = default(int?), bool? Owned = default(bool?), int? SkinId = default(int?))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PersonalizedOffersLcdsChampionSkinDTO);
        }

        /// <summary>
        /// Returns true if PersonalizedOffersLcdsChampionSkinDTO instances are equal
        /// </summary>
        /// <param name="other">Instance of PersonalizedOffersLcdsChampionSkinDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PersonalizedOffersLcdsChampionSkinDTO other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
