...
namespace LeagueClientApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LolQueueEligibilityCollectionsOwnership :  IEquatable<LolQueueEligibilityCollectionsOwnership>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LolQueueEligibilityCollectionsOwnership" /> class.
        /// </summary>
        /// <param name="FreeToPlayReward">FreeToPlayReward.</param>
        /// <param name="Owned">Owned.</param>
        /// <param name="Rental">Rental.</param>
        public LolQueueEligibilityCollectionsOwnership(bool? FreeToPlayReward = default(bool?), bool? Owned = default(bool?), LolQueueEligibilityCollectionsRental Rental = default(LolQueueEligibilityCollectionsRental))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LolQueueEligibilityCollectionsOwnership {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as LolQueueEligibilityCollectionsOwnership);
        }

        /// <summary>
        /// Returns true if LolQueueEligibilityCollectionsOwnership instances are equal
        /// </summary>
        /// <param name="other">Instance of LolQueueEligibilityCollectionsOwnership to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LolQueueEligibilityCollectionsOwnership other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
