...
namespace LeagueClientApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LolPerksChampSelectMySelection :  IEquatable<LolPerksChampSelectMySelection>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LolPerksChampSelectMySelection" /> class.
        /// </summary>
        ...
        public LolPerksChampSelectMySelection(int? SelectedSkinId = default(int?), long? Spell1Id = default(long?), long? Spell2Id = default(long?), long? WardSkinId = default(long?))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as LolPerksChampSelectMySelection);
        }

        /// <summary>
        /// Returns true if LolPerksChampSelectMySelection instances are equal
        /// </summary>
        /// <param name="other">Instance of LolPerksChampSelectMySelection to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LolPerksChampSelectMySelection other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
