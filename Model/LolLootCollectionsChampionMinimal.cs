...
namespace LeagueClientApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LolLootCollectionsChampionMinimal :  IEquatable<LolLootCollectionsChampionMinimal>, IValidatableObject
    {
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as LolLootCollectionsChampionMinimal);
        }

        /// <summary>
        /// Returns true if LolLootCollectionsChampionMinimal instances are equal
        /// </summary>
        /// <param name="other">Instance of LolLootCollectionsChampionMinimal to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LolLootCollectionsChampionMinimal other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
