...
namespace LeagueClientApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LolPerksSummoner :  IEquatable<LolPerksSummoner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LolPerksSummoner" /> class.
        /// </summary>
        ...
        public LolPerksSummoner(long? AccountId = default(long?), string DisplayName = default(string), string InternalName = default(string), string LastSeasonHighestRank = default(string), int? PercentCompleteForNextLevel = default(int?), int? ProfileIconId = default(int?), string Puuid = default(string), LolPerksSummonerRerollPoints RerollPoints = default(LolPerksSummonerRerollPoints), long? SummonerId = default(long?), int? SummonerLevel = default(int?), long? XpSinceLastLevel = default(long?), long? XpUntilNextLevel = default(long?))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LolPerksSummoner {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as LolPerksSummoner);
        }

        /// <summary>
        /// Returns true if LolPerksSummoner instances are equal
        /// </summary>
        /// <param name="other">Instance of LolPerksSummoner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LolPerksSummoner other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
