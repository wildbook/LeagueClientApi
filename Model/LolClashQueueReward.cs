...
namespace LeagueClientApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LolClashQueueReward :  IEquatable<LolClashQueueReward>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LolClashQueueReward" /> class.
        /// </summary>
        ...
        public LolClashQueueReward(bool? IsChampionPointsEnabled = default(bool?), bool? IsIpEnabled = default(bool?), bool? IsXpEnabled = default(bool?), List<int?> PartySizeIpRewards = default(List<int?>))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as LolClashQueueReward);
        }

        /// <summary>
        /// Returns true if LolClashQueueReward instances are equal
        /// </summary>
        /// <param name="other">Instance of LolClashQueueReward to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LolClashQueueReward other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
