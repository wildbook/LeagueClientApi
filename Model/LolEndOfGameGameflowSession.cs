...
namespace LeagueClientApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LolEndOfGameGameflowSession :  IEquatable<LolEndOfGameGameflowSession>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LolEndOfGameGameflowSession" /> class.
        /// </summary>
        /// <param name="GameClient">GameClient.</param>
        /// <param name="GameData">GameData.</param>
        /// <param name="Phase">Phase.</param>
        public LolEndOfGameGameflowSession(LolEndOfGameGameflowClient GameClient = default(LolEndOfGameGameflowClient), LolEndOfGameGameflowGameData GameData = default(LolEndOfGameGameflowGameData), LolEndOfGameGameflowPhase Phase = default(LolEndOfGameGameflowPhase))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as LolEndOfGameGameflowSession);
        }

        /// <summary>
        /// Returns true if LolEndOfGameGameflowSession instances are equal
        /// </summary>
        /// <param name="other">Instance of LolEndOfGameGameflowSession to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LolEndOfGameGameflowSession other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
