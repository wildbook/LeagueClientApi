...
namespace LeagueClientApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ClubsSummoner :  IEquatable<ClubsSummoner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ClubsSummoner" /> class.
        /// </summary>
        /// <param name="DisplayName">DisplayName.</param>
        /// <param name="ProfileIconId">ProfileIconId.</param>
        /// <param name="SummonerId">SummonerId.</param>
        public ClubsSummoner(string DisplayName = default(string), int? ProfileIconId = default(int?), long? SummonerId = default(long?))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ClubsSummoner);
        }

        /// <summary>
        /// Returns true if ClubsSummoner instances are equal
        /// </summary>
        /// <param name="other">Instance of ClubsSummoner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ClubsSummoner other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
