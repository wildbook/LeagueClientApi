...
namespace LeagueClientApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LolLootLoginDataPacket :  IEquatable<LolLootLoginDataPacket>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LolLootLoginDataPacket" /> class.
        /// </summary>
        /// <param name="AllSummonerData">AllSummonerData.</param>
        /// <param name="SimpleMessages">SimpleMessages.</param>
        public LolLootLoginDataPacket(LolLootLoginAllSummonerData AllSummonerData = default(LolLootLoginAllSummonerData), List<LolLootLoginSimpleMessage> SimpleMessages = default(List<LolLootLoginSimpleMessage>))
        {
        ...
        public List<LolLootLoginSimpleMessage> SimpleMessages { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as LolLootLoginDataPacket);
        }

        /// <summary>
        /// Returns true if LolLootLoginDataPacket instances are equal
        /// </summary>
        /// <param name="other">Instance of LolLootLoginDataPacket to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LolLootLoginDataPacket other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
