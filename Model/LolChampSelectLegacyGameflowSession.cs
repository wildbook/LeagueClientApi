...
namespace LeagueClientApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LolChampSelectLegacyGameflowSession :  IEquatable<LolChampSelectLegacyGameflowSession>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LolChampSelectLegacyGameflowSession" /> class.
        /// </summary>
        /// <param name="GameClient">GameClient.</param>
        /// <param name="GameData">GameData.</param>
        /// <param name="Phase">Phase.</param>
        public LolChampSelectLegacyGameflowSession(LolChampSelectLegacyGameflowGameClient GameClient = default(LolChampSelectLegacyGameflowGameClient), LolChampSelectLegacyGameflowGameData GameData = default(LolChampSelectLegacyGameflowGameData), LolChampSelectLegacyGameflowPhase Phase = default(LolChampSelectLegacyGameflowPhase))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as LolChampSelectLegacyGameflowSession);
        }

        /// <summary>
        /// Returns true if LolChampSelectLegacyGameflowSession instances are equal
        /// </summary>
        /// <param name="other">Instance of LolChampSelectLegacyGameflowSession to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LolChampSelectLegacyGameflowSession other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
