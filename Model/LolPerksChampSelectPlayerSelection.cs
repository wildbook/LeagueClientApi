...
namespace LeagueClientApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LolPerksChampSelectPlayerSelection :  IEquatable<LolPerksChampSelectPlayerSelection>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LolPerksChampSelectPlayerSelection" /> class.
        /// </summary>
        ...
        public LolPerksChampSelectPlayerSelection(string AssignedPosition = default(string), long? CellId = default(long?), int? ChampionId = default(int?), int? ChampionPickIntent = default(int?), string DisplayName = default(string), string PlayerType = default(string), int? SelectedSkinId = default(int?), long? Spell1Id = default(long?), long? Spell2Id = default(long?), long? SummonerId = default(long?), int? Team = default(int?), long? WardSkinId = default(long?))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as LolPerksChampSelectPlayerSelection);
        }

        /// <summary>
        /// Returns true if LolPerksChampSelectPlayerSelection instances are equal
        /// </summary>
        /// <param name="other">Instance of LolPerksChampSelectPlayerSelection to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LolPerksChampSelectPlayerSelection other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
