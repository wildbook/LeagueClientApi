...
namespace LeagueClientApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LolLobbyTeamBuilderActionV1 :  IEquatable<LolLobbyTeamBuilderActionV1>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LolLobbyTeamBuilderActionV1" /> class.
        /// </summary>
        ...
        public LolLobbyTeamBuilderActionV1(int? ActionId = default(int?), int? ActorCellId = default(int?), int? ChampionId = default(int?), bool? Completed = default(bool?), long? Duration = default(long?), string Type = default(string))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as LolLobbyTeamBuilderActionV1);
        }

        /// <summary>
        /// Returns true if LolLobbyTeamBuilderActionV1 instances are equal
        /// </summary>
        /// <param name="other">Instance of LolLobbyTeamBuilderActionV1 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LolLobbyTeamBuilderActionV1 other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
