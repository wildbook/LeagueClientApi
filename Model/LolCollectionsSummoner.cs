...
namespace LeagueClientApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LolCollectionsSummoner :  IEquatable<LolCollectionsSummoner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LolCollectionsSummoner" /> class.
        /// </summary>
        ...
        public LolCollectionsSummoner(long? AccountId = default(long?), int? ProfileIconId = default(int?), long? SummonerId = default(long?), int? SummonerLevel = default(int?))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as LolCollectionsSummoner);
        }

        /// <summary>
        /// Returns true if LolCollectionsSummoner instances are equal
        /// </summary>
        /// <param name="other">Instance of LolCollectionsSummoner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LolCollectionsSummoner other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
