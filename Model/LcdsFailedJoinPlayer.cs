...
namespace LeagueClientApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LcdsFailedJoinPlayer :  IEquatable<LcdsFailedJoinPlayer>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LcdsFailedJoinPlayer" /> class.
        /// </summary>
        /// <param name="ReasonFailed">ReasonFailed.</param>
        /// <param name="Summoner">Summoner.</param>
        public LcdsFailedJoinPlayer(string ReasonFailed = default(string), LcdsSummoner Summoner = default(LcdsSummoner))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as LcdsFailedJoinPlayer);
        }

        /// <summary>
        /// Returns true if LcdsFailedJoinPlayer instances are equal
        /// </summary>
        /// <param name="other">Instance of LcdsFailedJoinPlayer to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LcdsFailedJoinPlayer other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
