...
namespace LeagueClientApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LolChampSelectLegacyChampSelectMySelection :  IEquatable<LolChampSelectLegacyChampSelectMySelection>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LolChampSelectLegacyChampSelectMySelection" /> class.
        /// </summary>
        ...
        public LolChampSelectLegacyChampSelectMySelection(int? SelectedSkinId = default(int?), long? Spell1Id = default(long?), long? Spell2Id = default(long?), long? WardSkinId = default(long?))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LolChampSelectLegacyChampSelectMySelection {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as LolChampSelectLegacyChampSelectMySelection);
        }

        /// <summary>
        /// Returns true if LolChampSelectLegacyChampSelectMySelection instances are equal
        /// </summary>
        /// <param name="other">Instance of LolChampSelectLegacyChampSelectMySelection to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LolChampSelectLegacyChampSelectMySelection other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
