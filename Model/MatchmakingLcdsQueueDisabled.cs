...
namespace LeagueClientApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MatchmakingLcdsQueueDisabled :  IEquatable<MatchmakingLcdsQueueDisabled>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MatchmakingLcdsQueueDisabled" /> class.
        /// </summary>
        /// <param name="Message">Message.</param>
        /// <param name="QueueId">QueueId.</param>
        /// <param name="ReasonFailed">ReasonFailed.</param>
        /// <param name="Summoner">Summoner.</param>
        public MatchmakingLcdsQueueDisabled(string Message = default(string), int? QueueId = default(int?), string ReasonFailed = default(string), MatchmakingLcdsSummoner Summoner = default(MatchmakingLcdsSummoner))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MatchmakingLcdsQueueDisabled {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as MatchmakingLcdsQueueDisabled);
        }

        /// <summary>
        /// Returns true if MatchmakingLcdsQueueDisabled instances are equal
        /// </summary>
        /// <param name="other">Instance of MatchmakingLcdsQueueDisabled to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MatchmakingLcdsQueueDisabled other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
