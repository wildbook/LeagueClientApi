...
namespace LeagueClientApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MatchmakingLcdsQueueThrottled :  IEquatable<MatchmakingLcdsQueueThrottled>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MatchmakingLcdsQueueThrottled" /> class.
        /// </summary>
        /// <param name="Message">Message.</param>
        /// <param name="QueueId">QueueId.</param>
        /// <param name="ReasonFailed">ReasonFailed.</param>
        /// <param name="Summoner">Summoner.</param>
        public MatchmakingLcdsQueueThrottled(string Message = default(string), int? QueueId = default(int?), string ReasonFailed = default(string), MatchmakingLcdsSummoner Summoner = default(MatchmakingLcdsSummoner))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as MatchmakingLcdsQueueThrottled);
        }

        /// <summary>
        /// Returns true if MatchmakingLcdsQueueThrottled instances are equal
        /// </summary>
        /// <param name="other">Instance of MatchmakingLcdsQueueThrottled to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MatchmakingLcdsQueueThrottled other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
