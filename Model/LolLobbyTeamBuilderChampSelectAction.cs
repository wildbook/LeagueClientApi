...
namespace LeagueClientApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LolLobbyTeamBuilderChampSelectAction :  IEquatable<LolLobbyTeamBuilderChampSelectAction>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LolLobbyTeamBuilderChampSelectAction" /> class.
        /// </summary>
        ...
        public LolLobbyTeamBuilderChampSelectAction(long? ActorCellId = default(long?), int? ChampionId = default(int?), bool? Completed = default(bool?), long? Id = default(long?), string Type = default(string))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as LolLobbyTeamBuilderChampSelectAction);
        }

        /// <summary>
        /// Returns true if LolLobbyTeamBuilderChampSelectAction instances are equal
        /// </summary>
        /// <param name="other">Instance of LolLobbyTeamBuilderChampSelectAction to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LolLobbyTeamBuilderChampSelectAction other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
