...
namespace LeagueClientApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MatchmakingLcdsGameNotification :  IEquatable<MatchmakingLcdsGameNotification>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MatchmakingLcdsGameNotification" /> class.
        /// </summary>
        /// <param name="MessageArgument">MessageArgument.</param>
        /// <param name="MessageCode">MessageCode.</param>
        /// <param name="Type">Type.</param>
        public MatchmakingLcdsGameNotification(string MessageArgument = default(string), string MessageCode = default(string), string Type = default(string))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as MatchmakingLcdsGameNotification);
        }

        /// <summary>
        /// Returns true if MatchmakingLcdsGameNotification instances are equal
        /// </summary>
        /// <param name="other">Instance of MatchmakingLcdsGameNotification to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MatchmakingLcdsGameNotification other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
