...
namespace LeagueClientApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LcdsPlayer :  IEquatable<LcdsPlayer>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LcdsPlayer" /> class.
        /// </summary>
        /// <param name="SummonerId">SummonerId.</param>
        /// <param name="SummonerName">SummonerName.</param>
        public LcdsPlayer(long? SummonerId = default(long?), string SummonerName = default(string))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as LcdsPlayer);
        }

        /// <summary>
        /// Returns true if LcdsPlayer instances are equal
        /// </summary>
        /// <param name="other">Instance of LcdsPlayer to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LcdsPlayer other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
