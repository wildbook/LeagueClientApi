...
namespace LeagueClientApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LolChampionsCollectionsRental :  IEquatable<LolChampionsCollectionsRental>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LolChampionsCollectionsRental" /> class.
        /// </summary>
        ...
        public LolChampionsCollectionsRental(long? EndDate = default(long?), long? PurchaseDate = default(long?), bool? Rented = default(bool?), int? WinCountRemaining = default(int?))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as LolChampionsCollectionsRental);
        }

        /// <summary>
        /// Returns true if LolChampionsCollectionsRental instances are equal
        /// </summary>
        /// <param name="other">Instance of LolChampionsCollectionsRental to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LolChampionsCollectionsRental other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
