...
namespace LeagueClientApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PlayerNotificationResource :  IEquatable<PlayerNotificationResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PlayerNotificationResource" /> class.
        /// </summary>
        ...
        public PlayerNotificationResource(string BackgroundUrl = default(string), string Created = default(string), bool? Critical = default(bool?), Dictionary<string, string> Data = default(Dictionary<string, string>), string DetailKey = default(string), bool? Dismissible = default(bool?), string Expires = default(string), string IconUrl = default(string), long? Id = default(long?), string Source = default(string), string State = default(string), string TitleKey = default(string), string Type = default(string))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PlayerNotificationResource);
        }

        /// <summary>
        /// Returns true if PlayerNotificationResource instances are equal
        /// </summary>
        /// <param name="other">Instance of PlayerNotificationResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PlayerNotificationResource other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                ...
                (
                    this.Dismissible == other.Dismissible ||
                    this.Dismissible != null &&
                    this.Dismissible.Equals(other.Dismissible)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.Dismissible != null)
                    hash = hash * 59 + this.Dismissible.GetHashCode();
