...
namespace LeagueClientApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LcdsBotParticipant :  IEquatable<LcdsBotParticipant>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LcdsBotParticipant" /> class.
        /// </summary>
        ...
        public LcdsBotParticipant(int? BotSkillLevel = default(int?), long? SummonerId = default(long?), string SummonerInternalName = default(string), string SummonerName = default(string), string TeamId = default(string))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as LcdsBotParticipant);
        }

        /// <summary>
        /// Returns true if LcdsBotParticipant instances are equal
        /// </summary>
        /// <param name="other">Instance of LcdsBotParticipant to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LcdsBotParticipant other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
