...
namespace LeagueClientApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LolPerksPerkGDSResource :  IEquatable<LolPerksPerkGDSResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LolPerksPerkGDSResource" /> class.
        /// </summary>
        ...
        public LolPerksPerkGDSResource(string IconPath = default(string), int? Id = default(int?), string LongDesc = default(string), string Name = default(string), string ShortDesc = default(string), string Tooltip = default(string))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as LolPerksPerkGDSResource);
        }

        /// <summary>
        /// Returns true if LolPerksPerkGDSResource instances are equal
        /// </summary>
        /// <param name="other">Instance of LolPerksPerkGDSResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LolPerksPerkGDSResource other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
