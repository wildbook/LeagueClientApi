...
namespace LeagueClientApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class EndOfGameLcdsEndOfGameStats :  IEquatable<EndOfGameLcdsEndOfGameStats>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EndOfGameLcdsEndOfGameStats" /> class.
        /// </summary>
        ...
        /// <param name="MyTeamInfo">MyTeamInfo.</param>
        /// <param name="MyTeamStatus">MyTeamStatus.</param>
        /// <param name="NewSpells">NewSpells.</param>
        /// <param name="OdinBonusIp">OdinBonusIp.</param>
        /// <param name="OtherTeamInfo">OtherTeamInfo.</param>
        /// <param name="OtherTeamPlayerParticipantStats">OtherTeamPlayerParticipantStats.</param>
        ...
        /// <param name="TeamPlayerParticipantStats">TeamPlayerParticipantStats.</param>
        /// <param name="TimeUntilNextFirstWinBonus">TimeUntilNextFirstWinBonus.</param>
        /// <param name="UserId">UserId.</param>
        public EndOfGameLcdsEndOfGameStats(int? BasePoints = default(int?), int? BattleBoostIpEarned = default(int?), int? BoostIpEarned = default(int?), int? BoostXpEarned = default(int?), bool? CausedEarlySurrender = default(bool?), int? CoOpVsAiMinutesLeftToday = default(int?), int? CoOpVsAiMsecsUntilReset = default(int?), int? CompletionBonusPoints = default(int?), int? CustomMinutesLeftToday = default(int?), int? CustomMsecsUntilReset = default(int?), string Difficulty = default(string), bool? EarlySurrenderAccomplice = default(bool?), int? Elo = default(int?), int? EloChange = default(int?), int? ExperienceEarned = default(int?), int? ExperienceTotal = default(int?), int? FirstWinBonus = default(int?), bool? GameEndedInEarlySurrender = default(bool?), long? GameId = default(long?), int? GameLength = default(int?), string GameMode = default(string), List<string> GameMutators = default(List<string>), string GameType = default(string), bool? ImbalancedTeamsNoPoints = default(bool?), bool? Invalid = default(bool?), int? IpEarned = default(int?), int? IpTotal = default(int?), bool? LeveledUp = default(bool?), int? LoyaltyBoostIpEarned = default(int?), int? LoyaltyBoostXpEarned = default(int?), EndOfGameLcdsTeamInfo MyTeamInfo = default(EndOfGameLcdsTeamInfo), string MyTeamStatus = default(string), List<EndOfGameLcdsSpell> NewSpells = default(List<EndOfGameLcdsSpell>), int? OdinBonusIp = default(int?), EndOfGameLcdsTeamInfo OtherTeamInfo = default(EndOfGameLcdsTeamInfo), List<EndOfGameLcdsPlayerParticipantStatsSummary> OtherTeamPlayerParticipantStats = default(List<EndOfGameLcdsPlayerParticipantStatsSummary>), int? PartyRewardsBonusIpEarned = default(int?), List<EndOfGameLcdsPointsPenalty> PointsPenalties = default(List<EndOfGameLcdsPointsPenalty>), long? PreviousLevel = default(long?), long? PreviousXpTotal = default(long?), int? QueueBonusEarned = default(int?), string QueueType = default(string), bool? Ranked = default(bool?), long? ReportGameId = default(long?), string RoomName = default(string), string RoomPassword = default(string), int? RpEarned = default(int?), bool? SendStatsToTournamentProvider = default(bool?), int? SkinId = default(int?), int? SkinIndex = default(int?), string SummonerName = default(string), int? TalentPointsGained = default(int?), bool? TeamEarlySurrendered = default(bool?), List<EndOfGameLcdsPlayerParticipantStatsSummary> TeamPlayerParticipantStats = default(List<EndOfGameLcdsPlayerParticipantStatsSummary>), int? TimeUntilNextFirstWinBonus = default(int?), long? UserId = default(long?))
        {
        ...
        /// <summary>
        /// Gets or Sets MyTeamInfo
        /// </summary>
        [DataMember(Name="myTeamInfo", EmitDefaultValue=false)]
        public EndOfGameLcdsTeamInfo MyTeamInfo { get; set; }
        ...
        public List<EndOfGameLcdsSpell> NewSpells { get; set; }
        ...
        /// <summary>
        /// Gets or Sets OtherTeamInfo
        /// </summary>
        [DataMember(Name="otherTeamInfo", EmitDefaultValue=false)]
        public EndOfGameLcdsTeamInfo OtherTeamInfo { get; set; }

        /// <summary>
        /// Gets or Sets OtherTeamPlayerParticipantStats
        /// </summary>
        [DataMember(Name="otherTeamPlayerParticipantStats", EmitDefaultValue=false)]
        public List<EndOfGameLcdsPlayerParticipantStatsSummary> OtherTeamPlayerParticipantStats { get; set; }
        ...
        public List<EndOfGameLcdsPointsPenalty> PointsPenalties { get; set; }
        ...
        /// <summary>
        /// Gets or Sets TeamPlayerParticipantStats
        /// </summary>
        [DataMember(Name="teamPlayerParticipantStats", EmitDefaultValue=false)]
        public List<EndOfGameLcdsPlayerParticipantStatsSummary> TeamPlayerParticipantStats { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EndOfGameLcdsEndOfGameStats {\n");
            ...
            sb.Append("  MyTeamInfo: ").Append(MyTeamInfo).Append("\n");
            ...
            sb.Append("  OtherTeamInfo: ").Append(OtherTeamInfo).Append("\n");
            sb.Append("  OtherTeamPlayerParticipantStats: ").Append(OtherTeamPlayerParticipantStats).Append("\n");
            ...
            sb.Append("  TeamPlayerParticipantStats: ").Append(TeamPlayerParticipantStats).Append("\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as EndOfGameLcdsEndOfGameStats);
        }

        /// <summary>
        /// Returns true if EndOfGameLcdsEndOfGameStats instances are equal
        /// </summary>
        /// <param name="other">Instance of EndOfGameLcdsEndOfGameStats to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EndOfGameLcdsEndOfGameStats other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                ...
                (
                    this.MyTeamInfo == other.MyTeamInfo ||
                    this.MyTeamInfo != null &&
                    this.MyTeamInfo.Equals(other.MyTeamInfo)
                ) && 
                (
                ...
                (
                    this.OtherTeamInfo == other.OtherTeamInfo ||
                    this.OtherTeamInfo != null &&
                    this.OtherTeamInfo.Equals(other.OtherTeamInfo)
                ) && 
                (
                    this.OtherTeamPlayerParticipantStats == other.OtherTeamPlayerParticipantStats ||
                    this.OtherTeamPlayerParticipantStats != null &&
                    this.OtherTeamPlayerParticipantStats.SequenceEqual(other.OtherTeamPlayerParticipantStats)
                ) && 
                (
                ...
                (
                    ...
                    this.PointsPenalties.SequenceEqual(other.PointsPenalties)
                ) && 
                (
                ...
                (
                    this.TeamPlayerParticipantStats == other.TeamPlayerParticipantStats ||
                    this.TeamPlayerParticipantStats != null &&
                    this.TeamPlayerParticipantStats.SequenceEqual(other.TeamPlayerParticipantStats)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.MyTeamInfo != null)
                    hash = hash * 59 + this.MyTeamInfo.GetHashCode();
                ...
                if (this.OtherTeamInfo != null)
                    hash = hash * 59 + this.OtherTeamInfo.GetHashCode();
                if (this.OtherTeamPlayerParticipantStats != null)
                    hash = hash * 59 + this.OtherTeamPlayerParticipantStats.GetHashCode();
                ...
                if (this.TeamPlayerParticipantStats != null)
                    hash = hash * 59 + this.TeamPlayerParticipantStats.GetHashCode();
