...
namespace LeagueClientApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LolLobbyTeamBuilderCountdownTimer :  IEquatable<LolLobbyTeamBuilderCountdownTimer>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LolLobbyTeamBuilderCountdownTimer" /> class.
        /// </summary>
        /// <param name="Counter">Counter.</param>
        /// <param name="PhaseName">PhaseName.</param>
        /// <param name="Timer">Timer.</param>
        public LolLobbyTeamBuilderCountdownTimer(int? Counter = default(int?), string PhaseName = default(string), long? Timer = default(long?))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as LolLobbyTeamBuilderCountdownTimer);
        }

        /// <summary>
        /// Returns true if LolLobbyTeamBuilderCountdownTimer instances are equal
        /// </summary>
        /// <param name="other">Instance of LolLobbyTeamBuilderCountdownTimer to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LolLobbyTeamBuilderCountdownTimer other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
