...
namespace LeagueClientApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SanitizerContainsSanitizedRequest :  IEquatable<SanitizerContainsSanitizedRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SanitizerContainsSanitizedRequest" /> class.
        /// </summary>
        /// <param name="AggressiveScan">AggressiveScan.</param>
        /// <param name="IncludeEmbedded">IncludeEmbedded.</param>
        /// <param name="Level">Level.</param>
        /// <param name="RemoveDisallowedChars">RemoveDisallowedChars.</param>
        /// <param name="Text">Text.</param>
        public SanitizerContainsSanitizedRequest(bool? AggressiveScan = default(bool?), bool? IncludeEmbedded = default(bool?), int? Level = default(int?), bool? RemoveDisallowedChars = default(bool?), string Text = default(string))
        {
        ...
        /// <summary>
        /// Gets or Sets IncludeEmbedded
        /// </summary>
        [DataMember(Name="includeEmbedded", EmitDefaultValue=false)]
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as SanitizerContainsSanitizedRequest);
        }

        /// <summary>
        /// Returns true if SanitizerContainsSanitizedRequest instances are equal
        /// </summary>
        /// <param name="other">Instance of SanitizerContainsSanitizedRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SanitizerContainsSanitizedRequest other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                ...
                (
                    this.IncludeEmbedded == other.IncludeEmbedded ||
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.IncludeEmbedded != null)
                    hash = hash * 59 + this.IncludeEmbedded.GetHashCode();
                if (this.Level != null)
