...
namespace LeagueClientApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LolChampSelectLegacyChampSelectSession :  IEquatable<LolChampSelectLegacyChampSelectSession>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LolChampSelectLegacyChampSelectSession" /> class.
        /// </summary>
        ...
        public LolChampSelectLegacyChampSelectSession(List<Object> Actions = default(List<Object>), bool? AllowBattleBoost = default(bool?), bool? AllowRerolling = default(bool?), bool? AllowSkinSelection = default(bool?), LolChampSelectLegacyChampSelectBannedChampions Bans = default(LolChampSelectLegacyChampSelectBannedChampions), LolChampSelectLegacyChampSelectChatRoomDetails ChatDetails = default(LolChampSelectLegacyChampSelectChatRoomDetails), bool? IsSpectating = default(bool?), long? LocalPlayerCellId = default(long?), List<LolChampSelectLegacyChampSelectPlayerSelection> MyTeam = default(List<LolChampSelectLegacyChampSelectPlayerSelection>), int? RerollsRemaining = default(int?), List<LolChampSelectLegacyChampSelectPlayerSelection> TheirTeam = default(List<LolChampSelectLegacyChampSelectPlayerSelection>), LolChampSelectLegacyChampSelectTimer Timer = default(LolChampSelectLegacyChampSelectTimer), List<LolChampSelectLegacyChampSelectTradeContract> Trades = default(List<LolChampSelectLegacyChampSelectTradeContract>))
        {
        ...
        public List<LolChampSelectLegacyChampSelectPlayerSelection> MyTeam { get; set; }
        ...
        public List<LolChampSelectLegacyChampSelectPlayerSelection> TheirTeam { get; set; }
        ...
        public List<LolChampSelectLegacyChampSelectTradeContract> Trades { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as LolChampSelectLegacyChampSelectSession);
        }

        /// <summary>
        /// Returns true if LolChampSelectLegacyChampSelectSession instances are equal
        /// </summary>
        /// <param name="other">Instance of LolChampSelectLegacyChampSelectSession to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LolChampSelectLegacyChampSelectSession other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
