...
namespace LeagueClientApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LolChampSelectChampSelectChatRoomDetails :  IEquatable<LolChampSelectChampSelectChatRoomDetails>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LolChampSelectChampSelectChatRoomDetails" /> class.
        /// </summary>
        /// <param name="ChatRoomName">ChatRoomName.</param>
        /// <param name="ChatRoomPassword">ChatRoomPassword.</param>
        public LolChampSelectChampSelectChatRoomDetails(string ChatRoomName = default(string), string ChatRoomPassword = default(string))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as LolChampSelectChampSelectChatRoomDetails);
        }

        /// <summary>
        /// Returns true if LolChampSelectChampSelectChatRoomDetails instances are equal
        /// </summary>
        /// <param name="other">Instance of LolChampSelectChampSelectChatRoomDetails to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LolChampSelectChampSelectChatRoomDetails other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
