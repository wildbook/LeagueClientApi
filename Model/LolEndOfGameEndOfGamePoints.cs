...
namespace LeagueClientApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LolEndOfGameEndOfGamePoints :  IEquatable<LolEndOfGameEndOfGamePoints>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LolEndOfGameEndOfGamePoints" /> class.
        /// </summary>
        ...
        public LolEndOfGameEndOfGamePoints(int? PointChangeFromChampionsOwned = default(int?), int? PointChangeFromGameplay = default(int?), int? PointsUntilNextReroll = default(int?), int? PointsUsed = default(int?), int? PreviousPoints = default(int?), int? RerollCount = default(int?), int? TotalPoints = default(int?))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LolEndOfGameEndOfGamePoints {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as LolEndOfGameEndOfGamePoints);
        }

        /// <summary>
        /// Returns true if LolEndOfGameEndOfGamePoints instances are equal
        /// </summary>
        /// <param name="other">Instance of LolEndOfGameEndOfGamePoints to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LolEndOfGameEndOfGamePoints other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
