...
namespace LeagueClientApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LolChampSelectLegacyChampSelectPlayerSelection :  IEquatable<LolChampSelectLegacyChampSelectPlayerSelection>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LolChampSelectLegacyChampSelectPlayerSelection" /> class.
        /// </summary>
        ...
        public LolChampSelectLegacyChampSelectPlayerSelection(string AssignedPosition = default(string), long? CellId = default(long?), int? ChampionId = default(int?), int? ChampionPickIntent = default(int?), string DisplayName = default(string), string PlayerType = default(string), int? SelectedSkinId = default(int?), long? Spell1Id = default(long?), long? Spell2Id = default(long?), long? SummonerId = default(long?), int? Team = default(int?), long? WardSkinId = default(long?))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LolChampSelectLegacyChampSelectPlayerSelection {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as LolChampSelectLegacyChampSelectPlayerSelection);
        }

        /// <summary>
        /// Returns true if LolChampSelectLegacyChampSelectPlayerSelection instances are equal
        /// </summary>
        /// <param name="other">Instance of LolChampSelectLegacyChampSelectPlayerSelection to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LolChampSelectLegacyChampSelectPlayerSelection other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
