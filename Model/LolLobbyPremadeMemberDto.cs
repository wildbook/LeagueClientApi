...
namespace LeagueClientApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LolLobbyPremadeMemberDto :  IEquatable<LolLobbyPremadeMemberDto>, IValidatableObject
    {
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as LolLobbyPremadeMemberDto);
        }

        /// <summary>
        /// Returns true if LolLobbyPremadeMemberDto instances are equal
        /// </summary>
        /// <param name="other">Instance of LolLobbyPremadeMemberDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LolLobbyPremadeMemberDto other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
