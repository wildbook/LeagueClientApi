...
namespace LeagueClientApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LolAcsLoginSession :  IEquatable<LolAcsLoginSession>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LolAcsLoginSession" /> class.
        /// </summary>
        ...
        public LolAcsLoginSession(long? AccountId = default(long?), Object GasToken = default(Object), string IdToken = default(string), LolAcsLoginSessionStates State = default(LolAcsLoginSessionStates), long? SummonerId = default(long?))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as LolAcsLoginSession);
        }

        /// <summary>
        /// Returns true if LolAcsLoginSession instances are equal
        /// </summary>
        /// <param name="other">Instance of LolAcsLoginSession to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LolAcsLoginSession other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
