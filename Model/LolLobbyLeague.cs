...
namespace LeagueClientApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LolLobbyLeague :  IEquatable<LolLobbyLeague>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LolLobbyLeague" /> class.
        /// </summary>
        /// <param name="LeagueTier">LeagueTier.</param>
        /// <param name="QueueType">QueueType.</param>
        public LolLobbyLeague(string LeagueTier = default(string), string QueueType = default(string))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as LolLobbyLeague);
        }

        /// <summary>
        /// Returns true if LolLobbyLeague instances are equal
        /// </summary>
        /// <param name="other">Instance of LolLobbyLeague to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LolLobbyLeague other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
