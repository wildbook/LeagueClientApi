...
namespace LeagueClientApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MembershipInviteDto :  IEquatable<MembershipInviteDto>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MembershipInviteDto" /> class.
        /// </summary>
        ...
        public MembershipInviteDto(string ClubKey = default(string), string ClubName = default(string), long? InviteeAccountId = default(long?), string InviteePlatformId = default(string), long? InviteeSummonerId = default(long?), long? InviterAccountId = default(long?), string InviterPlatformId = default(string), long? InviterSummonerId = default(long?), int? Status = default(int?))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as MembershipInviteDto);
        }

        /// <summary>
        /// Returns true if MembershipInviteDto instances are equal
        /// </summary>
        /// <param name="other">Instance of MembershipInviteDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MembershipInviteDto other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
