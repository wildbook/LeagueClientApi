...
namespace LeagueClientApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LolLobbyQueue :  IEquatable<LolLobbyQueue>, IValidatableObject
    {
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as LolLobbyQueue);
        }

        /// <summary>
        /// Returns true if LolLobbyQueue instances are equal
        /// </summary>
        /// <param name="other">Instance of LolLobbyQueue to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LolLobbyQueue other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
