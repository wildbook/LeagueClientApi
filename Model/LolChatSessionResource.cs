...
namespace LeagueClientApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LolChatSessionResource :  IEquatable<LolChatSessionResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LolChatSessionResource" /> class.
        /// </summary>
        /// <param name="SessionExpire">SessionExpire.</param>
        /// <param name="SessionState">SessionState.</param>
        public LolChatSessionResource(int? SessionExpire = default(int?), LolChatSessionState SessionState = default(LolChatSessionState))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LolChatSessionResource {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as LolChatSessionResource);
        }

        /// <summary>
        /// Returns true if LolChatSessionResource instances are equal
        /// </summary>
        /// <param name="other">Instance of LolChatSessionResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LolChatSessionResource other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
