...
namespace LeagueClientApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PaymentsPMCStartUrlRequest :  IEquatable<PaymentsPMCStartUrlRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentsPMCStartUrlRequest" /> class.
        /// </summary>
        ...
        public PaymentsPMCStartUrlRequest(int? GifteeAccountId = default(int?), string GifteeMessage = default(string), bool? IsPrepaid = default(bool?), string LocaleId = default(string), int? SummonerLevel = default(int?))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PaymentsPMCStartUrlRequest);
        }

        /// <summary>
        /// Returns true if PaymentsPMCStartUrlRequest instances are equal
        /// </summary>
        /// <param name="other">Instance of PaymentsPMCStartUrlRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentsPMCStartUrlRequest other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
