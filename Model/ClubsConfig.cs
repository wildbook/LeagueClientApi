...
namespace LeagueClientApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ClubsConfig :  IEquatable<ClubsConfig>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ClubsConfig" /> class.
        /// </summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ClubsConfig);
        }

        /// <summary>
        /// Returns true if ClubsConfig instances are equal
        /// </summary>
        /// <param name="other">Instance of ClubsConfig to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ClubsConfig other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
