...
namespace LeagueClientApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LolPerksChampSelectTimer :  IEquatable<LolPerksChampSelectTimer>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LolPerksChampSelectTimer" /> class.
        /// </summary>
        ...
        public LolPerksChampSelectTimer(long? AdjustedTimeLeftInPhase = default(long?), int? AdjustedTimeLeftInPhaseInSec = default(int?), long? InternalNowInEpochMs = default(long?), bool? IsInfinite = default(bool?), string Phase = default(string), long? TimeLeftInPhase = default(long?), int? TimeLeftInPhaseInSec = default(int?), long? TotalTimeInPhase = default(long?))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LolPerksChampSelectTimer {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as LolPerksChampSelectTimer);
        }

        /// <summary>
        /// Returns true if LolPerksChampSelectTimer instances are equal
        /// </summary>
        /// <param name="other">Instance of LolPerksChampSelectTimer to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LolPerksChampSelectTimer other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
