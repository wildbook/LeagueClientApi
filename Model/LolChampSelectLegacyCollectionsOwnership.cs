...
namespace LeagueClientApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LolChampSelectLegacyCollectionsOwnership :  IEquatable<LolChampSelectLegacyCollectionsOwnership>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LolChampSelectLegacyCollectionsOwnership" /> class.
        /// </summary>
        /// <param name="FreeToPlayReward">FreeToPlayReward.</param>
        /// <param name="Owned">Owned.</param>
        /// <param name="Rental">Rental.</param>
        public LolChampSelectLegacyCollectionsOwnership(bool? FreeToPlayReward = default(bool?), bool? Owned = default(bool?), LolChampSelectLegacyCollectionsRental Rental = default(LolChampSelectLegacyCollectionsRental))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as LolChampSelectLegacyCollectionsOwnership);
        }

        /// <summary>
        /// Returns true if LolChampSelectLegacyCollectionsOwnership instances are equal
        /// </summary>
        /// <param name="other">Instance of LolChampSelectLegacyCollectionsOwnership to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LolChampSelectLegacyCollectionsOwnership other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
