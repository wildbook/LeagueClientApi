...
namespace LeagueClientApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LolLobbyQueueReward :  IEquatable<LolLobbyQueueReward>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LolLobbyQueueReward" /> class.
        /// </summary>
        ...
        public LolLobbyQueueReward(bool? IsChampionPointsEnabled = default(bool?), bool? IsIpEnabled = default(bool?), bool? IsXpEnabled = default(bool?), List<int?> PartySizeIpRewards = default(List<int?>))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as LolLobbyQueueReward);
        }

        /// <summary>
        /// Returns true if LolLobbyQueueReward instances are equal
        /// </summary>
        /// <param name="other">Instance of LolLobbyQueueReward to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LolLobbyQueueReward other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
