...
namespace LeagueClientApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LolEndOfGameEndOfGameTeam :  IEquatable<LolEndOfGameEndOfGameTeam>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LolEndOfGameEndOfGameTeam" /> class.
        /// </summary>
        ...
        public LolEndOfGameEndOfGameTeam(List<int?> ChampionBans = default(List<int?>), string FullId = default(string), bool? IsBottomTeam = default(bool?), bool? IsPlayerTeam = default(bool?), bool? IsWinningTeam = default(bool?), string MemberStatusString = default(string), string Name = default(string), List<LolEndOfGameEndOfGamePlayer> Players = default(List<LolEndOfGameEndOfGamePlayer>), Object Stats = default(Object), string Tag = default(string), int? TeamId = default(int?))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LolEndOfGameEndOfGameTeam {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as LolEndOfGameEndOfGameTeam);
        }

        /// <summary>
        /// Returns true if LolEndOfGameEndOfGameTeam instances are equal
        /// </summary>
        /// <param name="other">Instance of LolEndOfGameEndOfGameTeam to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LolEndOfGameEndOfGameTeam other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
