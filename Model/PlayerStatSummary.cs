...
namespace LeagueClientApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PlayerStatSummary :  IEquatable<PlayerStatSummary>, IValidatableObject
    {
        /// <summary>
        ...
        public PlayerStatSummary(long? Leaves = default(long?), long? Losses = default(long?), long? MaxRating = default(long?), string PlayerStatSummaryType = default(string), long? Rating = default(long?), long? Wins = default(long?))
        {
            this.Leaves = Leaves;
            this.Losses = Losses;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PlayerStatSummary);
        }

        /// <summary>
        /// Returns true if PlayerStatSummary instances are equal
        /// </summary>
        /// <param name="other">Instance of PlayerStatSummary to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PlayerStatSummary other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
