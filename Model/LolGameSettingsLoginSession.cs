...
namespace LeagueClientApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LolGameSettingsLoginSession :  IEquatable<LolGameSettingsLoginSession>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LolGameSettingsLoginSession" /> class.
        /// </summary>
        /// <param name="AccountId">AccountId.</param>
        /// <param name="GasToken">GasToken.</param>
        /// <param name="State">State.</param>
        /// <param name="SummonerId">SummonerId.</param>
        public LolGameSettingsLoginSession(long? AccountId = default(long?), Object GasToken = default(Object), LolGameSettingsLoginSessionStates State = default(LolGameSettingsLoginSessionStates), long? SummonerId = default(long?))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as LolGameSettingsLoginSession);
        }

        /// <summary>
        /// Returns true if LolGameSettingsLoginSession instances are equal
        /// </summary>
        /// <param name="other">Instance of LolGameSettingsLoginSession to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LolGameSettingsLoginSession other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
