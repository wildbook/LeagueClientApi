...
namespace LeagueClientApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LolClashClubsSummoner :  IEquatable<LolClashClubsSummoner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LolClashClubsSummoner" /> class.
        /// </summary>
        /// <param name="DisplayName">DisplayName.</param>
        /// <param name="ProfileIconId">ProfileIconId.</param>
        /// <param name="SummonerId">SummonerId.</param>
        public LolClashClubsSummoner(string DisplayName = default(string), int? ProfileIconId = default(int?), long? SummonerId = default(long?))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as LolClashClubsSummoner);
        }

        /// <summary>
        /// Returns true if LolClashClubsSummoner instances are equal
        /// </summary>
        /// <param name="other">Instance of LolClashClubsSummoner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LolClashClubsSummoner other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
