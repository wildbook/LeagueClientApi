...
namespace LeagueClientApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LolStorePlayer :  IEquatable<LolStorePlayer>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LolStorePlayer" /> class.
        /// </summary>
        /// <param name="AccountId">AccountId.</param>
        /// <param name="Ip">Ip.</param>
        /// <param name="Rp">Rp.</param>
        /// <param name="SummonerLevel">SummonerLevel.</param>
        public LolStorePlayer(long? AccountId = default(long?), long? Ip = default(long?), long? Rp = default(long?), int? SummonerLevel = default(int?))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as LolStorePlayer);
        }

        /// <summary>
        /// Returns true if LolStorePlayer instances are equal
        /// </summary>
        /// <param name="other">Instance of LolStorePlayer to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LolStorePlayer other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
