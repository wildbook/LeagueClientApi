...
namespace LeagueClientApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Summoner :  IEquatable<Summoner>, IValidatableObject
    {
        /// <summary>
        ...
        public Summoner(long? AcctId = default(long?), long? SumId = default(long?))
        {
            this.AcctId = AcctId;
            this.SumId = SumId;
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as Summoner);
        }

        /// <summary>
        /// Returns true if Summoner instances are equal
        /// </summary>
        /// <param name="other">Instance of Summoner to be compared</param>
        /// <returns>Boolean</returns>
