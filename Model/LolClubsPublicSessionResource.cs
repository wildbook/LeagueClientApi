...
namespace LeagueClientApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LolClubsPublicSessionResource :  IEquatable<LolClubsPublicSessionResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LolClubsPublicSessionResource" /> class.
        /// </summary>
        /// <param name="SessionExpire">SessionExpire.</param>
        /// <param name="SessionState">SessionState.</param>
        public LolClubsPublicSessionResource(int? SessionExpire = default(int?), string SessionState = default(string))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as LolClubsPublicSessionResource);
        }

        /// <summary>
        /// Returns true if LolClubsPublicSessionResource instances are equal
        /// </summary>
        /// <param name="other">Instance of LolClubsPublicSessionResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LolClubsPublicSessionResource other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
