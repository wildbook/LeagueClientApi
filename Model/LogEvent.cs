...
namespace LeagueClientApi.Model
{
    ...
    public partial class LogEvent :  IEquatable<LogEvent>, IValidatableObject
    {
        ...
        public LogEvent(string Message = default(string), LogSeverityLevels Severity = default(LogSeverityLevels))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as LogEvent);
        }

        /// <summary>
        /// Returns true if LogEvent instances are equal
        /// </summary>
        /// <param name="other">Instance of LogEvent to be compared</param>
        /// <returns>Boolean</returns>
