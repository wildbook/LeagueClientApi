...
namespace LeagueClientApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PublicSummonerDTO :  IEquatable<PublicSummonerDTO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PublicSummonerDTO" /> class.
        /// </summary>
        ...
        public PublicSummonerDTO(long? AcctId = default(long?), string InternalName = default(string), string Name = default(string), string PreviousSeasonHighestTier = default(string), int? ProfileIconId = default(int?), string Puuid = default(string), long? SummonerId = default(long?), int? SummonerLevel = default(int?))
        {
            this.AcctId = AcctId;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PublicSummonerDTO);
        }

        /// <summary>
        /// Returns true if PublicSummonerDTO instances are equal
        /// </summary>
        /// <param name="other">Instance of PublicSummonerDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PublicSummonerDTO other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
