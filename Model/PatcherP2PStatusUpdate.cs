...
namespace LeagueClientApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PatcherP2PStatusUpdate :  IEquatable<PatcherP2PStatusUpdate>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PatcherP2PStatusUpdate" /> class.
        /// </summary>
        /// <param name="IsAllowedByUser">IsAllowedByUser.</param>
        public PatcherP2PStatusUpdate(bool? IsAllowedByUser = default(bool?))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PatcherP2PStatusUpdate);
        }

        /// <summary>
        /// Returns true if PatcherP2PStatusUpdate instances are equal
        /// </summary>
        /// <param name="other">Instance of PatcherP2PStatusUpdate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PatcherP2PStatusUpdate other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
