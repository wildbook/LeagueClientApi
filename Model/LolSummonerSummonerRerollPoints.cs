...
namespace LeagueClientApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LolSummonerSummonerRerollPoints :  IEquatable<LolSummonerSummonerRerollPoints>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LolSummonerSummonerRerollPoints" /> class.
        /// </summary>
        ...
        /// <param name="PointsToReroll">PointsToReroll.</param>
        public LolSummonerSummonerRerollPoints(long? CurrentPoints = default(long?), int? MaxRolls = default(int?), int? NumberOfRolls = default(int?), long? PointsCostToRoll = default(long?), long? PointsToReroll = default(long?))
        {
        ...
        /// <summary>
        /// Gets or Sets PointsToReroll
        /// </summary>
        [DataMember(Name="pointsToReroll", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LolSummonerSummonerRerollPoints {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as LolSummonerSummonerRerollPoints);
        }

        /// <summary>
        /// Returns true if LolSummonerSummonerRerollPoints instances are equal
        /// </summary>
        /// <param name="other">Instance of LolSummonerSummonerRerollPoints to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LolSummonerSummonerRerollPoints other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                ...
                (
                    this.PointsToReroll == other.PointsToReroll ||
                    this.PointsToReroll != null &&
                    this.PointsToReroll.Equals(other.PointsToReroll)
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.PointsToReroll != null)
                    hash = hash * 59 + this.PointsToReroll.GetHashCode();
                return hash;
            }
        }
