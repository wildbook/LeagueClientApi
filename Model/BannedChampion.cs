...
namespace LeagueClientApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class BannedChampion :  IEquatable<BannedChampion>, IValidatableObject
    {
        /// <summary>
        ...
        public BannedChampion(int? ChampionId = default(int?), int? PickTurn = default(int?), int? TeamId = default(int?))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as BannedChampion);
        }

        /// <summary>
        /// Returns true if BannedChampion instances are equal
        /// </summary>
        /// <param name="other">Instance of BannedChampion to be compared</param>
        /// <returns>Boolean</returns>
