...
namespace LeagueClientApi.Model
{
    ...
    public partial class Bracket :  IEquatable<Bracket>, IValidatableObject
    {
        ...
        public Bracket(int? CurrentLoserRound = default(int?), int? CurrentRound = default(int?), long? Id = default(long?), List<BracketMatch> LoserBracketMatches = default(List<BracketMatch>), List<BracketMatch> Matches = default(List<BracketMatch>), long? PhaseId = default(long?), List<BracketRoster> Rosters = default(List<BracketRoster>), int? Size = default(int?), long? TournamentId = default(long?))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as Bracket);
        }

        /// <summary>
        /// Returns true if Bracket instances are equal
        /// </summary>
        /// <param name="other">Instance of Bracket to be compared</param>
        /// <returns>Boolean</returns>
