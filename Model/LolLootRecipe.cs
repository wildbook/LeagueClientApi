...
namespace LeagueClientApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LolLootRecipe :  IEquatable<LolLootRecipe>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LolLootRecipe" /> class.
        /// </summary>
        ...
        public LolLootRecipe(string CrafterName = default(string), string DisplayCategories = default(string), LolLootRecipeMetadata Metadata = default(LolLootRecipeMetadata), List<LolLootRecipeOutput> Outputs = default(List<LolLootRecipeOutput>), string RecipeName = default(string), List<LolLootRecipeSlot> Slots = default(List<LolLootRecipeSlot>), string Type = default(string))
        {
        ...
        public List<LolLootRecipeOutput> Outputs { get; set; }
        ...
        public List<LolLootRecipeSlot> Slots { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as LolLootRecipe);
        }

        /// <summary>
        /// Returns true if LolLootRecipe instances are equal
        /// </summary>
        /// <param name="other">Instance of LolLootRecipe to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LolLootRecipe other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
