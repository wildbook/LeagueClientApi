...
namespace LeagueClientApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LolGameQueuesQueueReward :  IEquatable<LolGameQueuesQueueReward>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LolGameQueuesQueueReward" /> class.
        /// </summary>
        ...
        public LolGameQueuesQueueReward(bool? IsChampionPointsEnabled = default(bool?), bool? IsIpEnabled = default(bool?), bool? IsXpEnabled = default(bool?), List<int?> PartySizeIpRewards = default(List<int?>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LolGameQueuesQueueReward {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as LolGameQueuesQueueReward);
        }

        /// <summary>
        /// Returns true if LolGameQueuesQueueReward instances are equal
        /// </summary>
        /// <param name="other">Instance of LolGameQueuesQueueReward to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LolGameQueuesQueueReward other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
